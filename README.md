...
Once your solution is open in Visual Studio, you'll want to enable Objective-C syntax highlighting and debugging.
...
8. [The iOS Bridge Samples Repo](https://github.com/Microsoft/WinObjC-Samples), for project samples apps and code using the bridge
