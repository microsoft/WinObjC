...
ShaderNode* buildLighter(const string& toLightTemp,
                         const string& attenTemp,
                         const string& pos,
                         const string& clr,
                         const string& attenName,
...
ShaderNode* buildSpecLighter(const string& toLightTemp,
                             const string& attenTemp,
                             const string& pos,
                             ShaderNode* specClrNode,
                             const string& attenName,
...
auto diffuseLighter = new ShaderOp(new ShaderAdditiveCombiner({ buildLighter(TO_LIGHT0_TMP,
                                                                             ATTEN_LIGHT0_TMP,
                                                                             GLKSH_LIGHT0_POS,
                                                                             GLKSH_LIGHT0_COLOR,
                                                                             GLKSH_LIGHT0_ATTEN,
                                                                ...
                                                                buildLighter(TO_LIGHT2_TMP,
                                                                             ...
                                                                             GLKSH_NORMAL_NAME) }),
                                   new ShaderVarRef(GLKSH_EMISSIVE),
                                   "max",
                                   false);

// Node that calculates specular lighting for up to 3 lights.
auto specularLighter = new ShaderAdditiveCombiner({ buildSpecLighter(TO_LIGHT0_TMP,
                                                                     ATTEN_LIGHT0_TMP,
                                                                     GLKSH_LIGHT0_POS,
                                                                     ...
                                                                     GLKSH_LIGHT0_SPOTDIR,
                                                                     GLKSH_NORMAL_NAME),
                                                    buildSpecLighter(TO_LIGHT1_TMP,
                                                                     ATTEN_LIGHT1_TMP,
                                                                     GLKSH_LIGHT1_POS,
                                                                     ...
                                                                     GLKSH_LIGHT1_SPOTDIR,
                                                                     GLKSH_NORMAL_NAME),
                                                    buildSpecLighter(TO_LIGHT2_TMP,
                                                                     ATTEN_LIGHT2_TMP,
                                                                     GLKSH_LIGHT2_POS,
...
auto ppdiffuseLighter = new ShaderOp(
    new ShaderFallbackNode({ new ShaderAdditiveCombiner({ buildLighter(new ShaderVarRef("_toLight0"),
                                                                       ATTEN_LIGHT0_TMP,
                                                                       GLKSH_LIGHT0_POS,
                                                                       GLKSH_LIGHT0_COLOR,
                                                                       GLKSH_LIGHT0_ATTEN,
                                                                       ...
                                                                       GLKSH_LIGHT0_SPOTDIR,
                                                                       "_vertNorm"),
                                                          buildLighter(new ShaderVarRef("_toLight1"),
                                                                       ATTEN_LIGHT1_TMP,
                                                                       GLKSH_LIGHT1_POS,
                                                                       GLKSH_LIGHT1_COLOR,
                                                                       GLKSH_LIGHT1_ATTEN,
                                                                       ...
                                                                       GLKSH_LIGHT1_SPOTDIR,
                                                                       "_vertNorm"),
                                                          buildLighter(new ShaderVarRef("_toLight2"),
                                                                       ATTEN_LIGHT2_TMP,
                                                                       GLKSH_LIGHT2_POS,
                                                                       GLKSH_LIGHT2_COLOR,
                                                                       GLKSH_LIGHT2_ATTEN,
...
auto ppspecularLighter = new ShaderAdditiveCombiner(
    { buildSpecLighter(new ShaderVarRef("_toLight0"),
                       new ShaderVarRef("_toCam"),
                       ATTEN_LIGHT0_TMP,
                       GLKSH_LIGHT0_POS,
                       new ShaderSpecularTex(
                           GLKSH_SPECULAR_TEX, new ShaderVarRef("_texCoord0"), new ShaderVarRef(GLKSH_LIGHT0_SPECULAR)),
                       GLKSH_LIGHT0_ATTEN,
                       GLKSH_LIGHT0_SPOT,
                       GLKSH_LIGHT0_SPOTDIR,
                       "_vertNorm"),
      buildSpecLighter(new ShaderVarRef("_toLight1"),
                       new ShaderVarRef("_toCam"),
                       ATTEN_LIGHT1_TMP,
                       GLKSH_LIGHT1_POS,
                       new ShaderSpecularTex(
                           GLKSH_SPECULAR_TEX, new ShaderVarRef("_texCoord0"), new ShaderVarRef(GLKSH_LIGHT1_SPECULAR)),
                       GLKSH_LIGHT1_ATTEN,
                       GLKSH_LIGHT1_SPOT,
                       GLKSH_LIGHT1_SPOTDIR,
                       "_vertNorm"),
      buildSpecLighter(new ShaderVarRef("_toLight2"),
                       new ShaderVarRef("_toCam"),
                       ATTEN_LIGHT2_TMP,
                       GLKSH_LIGHT2_POS,
                       new ShaderSpecularTex(
                           GLKSH_SPECULAR_TEX, new ShaderVarRef("_texCoord0"), new ShaderVarRef(GLKSH_LIGHT2_SPECULAR)),
                       GLKSH_LIGHT2_ATTEN,
                       GLKSH_LIGHT2_SPOT,
                       GLKSH_LIGHT2_SPOTDIR,
                       "_vertNorm") });
...
ShaderDef standardVsh({ { GL_INPUT_POS, new ShaderTempRef(GLKS_FLOAT4, TRANSFORMED_POS, new ShaderPosRef()) },
