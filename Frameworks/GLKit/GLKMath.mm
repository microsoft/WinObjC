...
GLKVector3 GLKMathUnproject(GLKVector3 window, GLKMatrix4 model, GLKMatrix4 projection, int* viewport, bool* success) {
    ...
    GLKVector4 normalisedVector =
        GLKVector4Make((2 * window.x / viewport[2] - 1), (2 * (window.y - viewport[1]) / viewport[3] - 1), 2 * window.z - 1, 1);
...
GLKMatrix3 GLKMatrix3Scale(GLKMatrix3 matrix, float sx, float sy, float sz) {
    GLKMatrix3 m = { matrix.m00 * sx, matrix.m01 * sx, matrix.m02 * sx, matrix.m10 * sy, matrix.m11 * sy,
                     matrix.m12 * sy, matrix.m20 * sz, matrix.m21 * sz, matrix.m22 * sz };
    return m;
}
...
GLKMatrix4 GLKMatrix4ScaleWithVector3(GLKMatrix4 matrix, GLKVector3 scaleVector) {
    GLKMatrix4 m = { matrix.m[0] * scaleVector.v[0],
                     matrix.m[1] * scaleVector.v[0],
                     matrix.m[2] * scaleVector.v[0],
                     matrix.m[3] * scaleVector.v[0],
                     matrix.m[4] * scaleVector.v[1],
                     matrix.m[5] * scaleVector.v[1],
                     matrix.m[6] * scaleVector.v[1],
                     matrix.m[7] * scaleVector.v[1],
                     matrix.m[8] * scaleVector.v[2],
                     matrix.m[9] * scaleVector.v[2],
                     matrix.m[10] * scaleVector.v[2],
                     matrix.m[11] * scaleVector.v[2],
                     matrix.m[12],
                     matrix.m[13],
                     matrix.m[14],
                     matrix.m[15] };
