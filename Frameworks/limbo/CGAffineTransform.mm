...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformConcat, ArgTypeWordPtr, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformMake, ArgTypeWordPtr, ArgTypeFloat, ArgTypeFloat, ArgTypeFloat, ArgTypeFloat, ArgTypeFloat, ArgTypeFloat)
DEFINE_FUNCTION_STRET_6(CGAffineTransform, CGAffineTransformMake, EbrFloatArg, a, EbrFloatArg, b, EbrFloatArg, c, EbrFloatArg, d, EbrFloatArg, tx, EbrFloatArg, ty)
{
    CGAffineTransform ret;
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformRotate, ArgTypeWordPtr, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformTranslate, ArgTypeWordPtr, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformScale, ArgTypeWordPtr, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformInvert, ArgTypeWordPtr, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformIsIdentity, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
...
DECLARE_FUNCTION_PARAMS(ArgTypeWord, CGAffineTransformEqualToTransform, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord, ArgTypeWord)
