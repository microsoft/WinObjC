...
IWPLATFORM_EXPORT void MD5Init(MD5_CTX* mdContext) {
...
IWPLATFORM_EXPORT void MD5Update(MD5_CTX* mdContext, unsigned char* inBuf, unsigned int inLen) {
    UINT4 in[16];
    int mdi;
    unsigned int i, ii;
...
IWPLATFORM_EXPORT void MD5Final(MD5_CTX* mdContext) {
    UINT4 in[16];
    int mdi;
    unsigned int i, ii;
    unsigned int padLen;
