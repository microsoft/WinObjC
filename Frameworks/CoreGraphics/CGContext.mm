...
void CGContextDrawGlyphRun(CGContextRef ctx, const DWRITE_GLYPH_RUN* glyphRun, bool invertedCoordinates) {
    ctx->Backing()->CGContextDrawGlyphRun(glyphRun, invertedCoordinates);
}
