...
@implementation NSDictionary : NSObject
    +(instancetype) dictionaryWithObjectsAndKeys:(id)firstObj , ...{
        va_list pReader; va_start(pReader, firstObj);
    ...
    -(NSDictionary*) initWithContentsOfFile:(NSString*)filename {
        ...
        if ( data ) {
            deserializedDict = [NSPropertyListSerialization propertyListFromData:data mutabilityOption:[self isKindOfClass:[NSMutableDictionary class]] ? NSPropertyListMutableContainersAndLeaves : NSPropertyListImmutable format:0 errorDescription:0];
    ...
    +(NSDictionary*) dictionaryWithContentsOfURL:(NSURL*)url {
        ...
        return [NSPropertyListSerialization propertyListFromData:data mutabilityOption:[self isKindOfClass:[NSMutableDictionary class]] ? NSPropertyListMutableContainersAndLeaves : NSPropertyListImmutable format:0 errorDescription:0];
    }
    ...
    -(NSDictionary*) initWithContentsOfURL:(id)url {
        ...
        if ( data ) {
            dict = [NSPropertyListSerialization propertyListFromData:data mutabilityOption:[self isKindOfClass:[NSMutableDictionary class]] ? NSPropertyListMutableContainersAndLeaves : NSPropertyListImmutable format:0 errorDescription:0];
        }
    ...
    -(NSString*) description {
        return [[NSString alloc] initWithData:[NSPropertyListSerialization dataFromPropertyList:self format:NSPropertyListXMLFormat_v1_0 errorDescription:nil] encoding:NSUTF8StringEncoding];
    }
    ...
    -(NSArray*) objectsForKeys:(NSArray*)keys notFoundMarker:(id)notFoundMarker {
        ...
        for (id curkey in keys) {
            ...
            if( object == nil ) object = notFoundMarker;
