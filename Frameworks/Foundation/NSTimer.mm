...
@implementation NSTimer {
    ...
    -(void) dealloc {
        ...
        if ( _userInfo != nil ) [_userInfo release];
    ...
    +(NSTimer*) scheduledTimerWithTimeInterval:(double)seconds target:(NSObject*)target selector:(SEL)selector userInfo:(NSObject*)userInfo repeats:(BOOL)repeats {
    ...
    +(NSTimer*) timerWithTimeInterval:(double)seconds target:(NSObject*)target selector:(SEL)selector userInfo:(NSObject*)userInfo repeats:(BOOL)repeats {
        NSTimer* pNewTimer = [self alloc];
    ...
    -(NSTimer*) initWithFireDate:(NSDate*)date interval:(double)seconds target:(NSObject*)target selector:(SEL)selector userInfo:(NSObject*)userInfo repeats:(BOOL)repeats {
