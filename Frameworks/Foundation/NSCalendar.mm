...
// TODO: Fix month-based date arithmetic. This crude approximation of seconds per month
// may not yield accurate results for date arithmetic when the days of month are near the
