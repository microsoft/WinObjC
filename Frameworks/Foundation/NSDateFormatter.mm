...
static void SetSymbolsFromNSArray(icu::DateFormat *formatter, NSArray *values, UDateFormatSymbolType symbol, int startIdx, UErrorCode &error)
{
    for ( int i = 0; i < [values count]; i ++ ) {
        NSString *symbolStr = [values objectAtIndex: i];

        udat_setSymbols((UDateFormat *) formatter, (UDateFormatSymbolType) symbol, i + startIdx, (UChar *) [symbolStr rawCharacters], [symbolStr length], &error);
    }
}

static std::map<ICUPropertyMapper::PropertyTypes, ICUPropertyMapper> _icuProperties = {
    { ICUPropertyMapper::lenient, ICUPropertyMapper(ICUPropertyMapper::lenient, 
    ...
    { ICUPropertyMapper::amSymbol, ICUPropertyMapper(ICUPropertyMapper::amSymbol, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
    ...
    { ICUPropertyMapper::pmSymbol, ICUPropertyMapper(ICUPropertyMapper::pmSymbol, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
    ...
    { ICUPropertyMapper::shortStandaloneWeekdaySymbols, ICUPropertyMapper(ICUPropertyMapper::shortStandaloneWeekdaySymbols, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
            SetSymbolsFromNSArray(formatter, (NSArray *) value._objValue, (UDateFormatSymbolType) UDAT_STANDALONE_SHORT_WEEKDAYS, 1, error);
        },
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
            value._objValue = NSArrayFromSymbols(formatter, (UDateFormatSymbolType) UDAT_STANDALONE_SHORT_WEEKDAYS, 1, error);
        })
    },

    { ICUPropertyMapper::weekdaySymbols, ICUPropertyMapper(ICUPropertyMapper::weekdaySymbols, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
    ...
    { ICUPropertyMapper::shortWeekdaySymbols, ICUPropertyMapper(ICUPropertyMapper::shortWeekdaySymbols, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
            SetSymbolsFromNSArray(formatter, (NSArray *) value._objValue, (UDateFormatSymbolType) UDAT_SHORT_WEEKDAYS, 1, error);
        },
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
    ...
    { ICUPropertyMapper::standaloneWeekdaySymbols, ICUPropertyMapper(ICUPropertyMapper::standaloneWeekdaySymbols, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
            SetSymbolsFromNSArray(formatter, (NSArray *) value._objValue, (UDateFormatSymbolType) UDAT_STANDALONE_WEEKDAYS, 1, error);
        },
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
    ...
    { ICUPropertyMapper::standaloneMonthSymbols, ICUPropertyMapper(ICUPropertyMapper::standaloneMonthSymbols, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
            SetSymbolsFromNSArray(formatter, (NSArray *) value._objValue, (UDateFormatSymbolType) UDAT_STANDALONE_MONTHS, 0, error);
        },
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
    ...
    { ICUPropertyMapper::monthSymbols, ICUPropertyMapper(ICUPropertyMapper::monthSymbols, 
        [](icu::DateFormat *formatter, ICUPropertyValue &value, UErrorCode &error) {
...
@implementation NSDateFormatter {
    ...
    -(icu::DateFormat*) _getFormatter
    {
        if ( !_formatter || _formatterNeedsRebuilding ) {
            ...
            if ( [_dateFormat length] > 0 ) {
		        ...
		        _formatter = icu::DateFormat::createDateTimeInstance(convertFormatterStyle(_dateStyle), convertFormatterStyle(_timeStyle), *icuLocale);
            }
	...
	-(NSDate *) dateFromString:(NSString *)str {
		...
		if ( !U_SUCCESS(status) )  return nil;
