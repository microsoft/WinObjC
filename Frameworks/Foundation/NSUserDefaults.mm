...
@implementation NSUserDefaults {
   ...
   BOOL _willSave;
    ...
    /* annotate with type */ -(id) dictionaryRepresentation {
    ...
    /* annotate with type */ -(void) registerDefaults:(id)values {
    ...
    /* annotate with type */ -(id) _scheduleSync {
        [self performSelector:@selector(synchronize) withObject:nil afterDelay:1.0];
        return self;
    }
    ...
    /* annotate with type */ -(void) addObserver:(id)observer forKeyPath:(id)keyPath options:(NSKeyValueObservingOptions)options context:(void*)context {
