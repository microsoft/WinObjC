...
@implementation NSValue : NSObject
    ...
    -(BOOL) isEqualToValue:(NSValue*)toValue {
        ...
        if ( _valueType != otherValue->_valueType ) return FALSE;
    ...
    -(NSString*) description {
        ...
        switch ( _valueType ) {
            ...
            case rectType:
                sprintf(szDescription, "{%f, %f} {%f, %f}}", v.rectValue.origin.x, v.rectValue.origin.y, v.rectValue.size.width, v.rectValue.size.height);
                return [NSString stringWithCString: szDescription];

            case transformType:
                sprintf(szDescription, "{%f, %f %f, %f}, {%f, %f %f, %f}, {%f, %f %f, %f}, {%f, %f %f, %f}}", 
                    v.transformValue.m11, v.transformValue.m12, v.transformValue.m13, v.transformValue.m14,
                    v.transformValue.m21, v.transformValue.m22, v.transformValue.m23, v.transformValue.m24,
                    v.transformValue.m31, v.transformValue.m32, v.transformValue.m33, v.transformValue.m34,
                    v.transformValue.m41, v.transformValue.m42, v.transformValue.m43, v.transformValue.m44);
