...
id EbrGetExternalCookies(id url) { return nil; }
...
@implementation NSHTTPCookieStorage : NSObject
    ...
    -(NSArray *) cookiesForURL:(NSURL *)url {
        ...
        while((cookie=[c nextObject]))
        {
            ...
            if( ![path isEqualToString:@"/"] && ![urlPath hasPrefix:path] &&
                ![urlPathWithSlash hasPrefix:path] )
    ...
    /* annotate with type */ -(void) deleteCookie:(id)cookie {
    ...
    /* annotate with type */ -(void) setCookie:(id)cookie {
        id key;
    ...
    /* annotate with type */ -(void) setCookies:(id)cookies forURL:(id)url mainDocumentURL:(id)mainURL {
        id c;
        id cookie;
        if(_cookieAcceptPolicy == NSHTTPCookieAcceptPolicyNever)
            return;
    ...
    /* annotate with type */ -(void) setCookieAcceptPolicy:(int)policy {
