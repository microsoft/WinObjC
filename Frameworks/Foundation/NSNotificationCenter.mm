...
@implementation NSNotificationCenter {
    ...
    -(void) postNotification:(NSNotification *)notification {
        ...
        for ( unsigned int i = 0; i < count; i ++ ) {
            ...
            if ( !observer->valid ) continue;
            if ( observer->notificationSender != NULL && observer->notificationSender != sender ) continue;
    ...
    -(id<NSObject>) addObserverForName:(NSString *)name object:(id)object queue:(NSNotificationQueue *)queue usingBlock:(void (^)(NSNotification *))block {
        if ( queue != nil ) {
    ...
    -(void) removeObserver:(id)observer name:(NSString *)name object:(id)object {
        ...
        for ( int i = numItems - 1; i >= 0; i -- ) {
            ...
            if ( !curObserver->valid ) continue;
            if ( curObserver->object != observer ) continue;
            if ( object != nil && curObserver->notificationSender != object ) continue;
