...
//  Derived from http://xith.org/archive/JavaCoolDude/JWS/Xith3D/Quake3/source/org/xith3d/loaders/md3/md3math/CQuaternion.java

class Quaternion
{
    union
    {
        struct { float w, x, y, z; }; // Q = ix + jy + kz + w
        float q[4];
    };
