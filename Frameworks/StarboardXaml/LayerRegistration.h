...
ref class XamlTypeInfoProvider sealed {
    internal : ::Windows::UI::Xaml::Markup::IXamlType ^ CreateXamlType(::Platform::String ^ typeName);
...
private:
    ...
    property::Platform::Collections::Vector<::Windows::UI::Xaml::Markup::IXamlMetadataProvider ^> ^
        OtherProviders { ::Platform::Collections::Vector<::Windows::UI::Xaml::Markup::IXamlMetadataProvider ^> ^ get(); }
...
public:
    virtual property::Windows::UI::Xaml::Markup::IXamlType ^ BaseType { ::Windows::UI::Xaml::Markup::IXamlType ^ get(); }

        virtual property Windows::UI::Xaml::Markup::IXamlMember ^
        ContentProperty { ::Windows::UI::Xaml::Markup::IXamlMember ^ get(); }

        virtual property::Platform::String ^
        FullName { ::Platform::String ^ get(); }

        virtual property::Platform::String ^
        Name { ::Platform::String ^ get(); }
    ...
    virtual property::Windows::UI::Xaml::Markup::IXamlType ^ ItemType { ::Windows::UI::Xaml::Markup::IXamlType ^ get(); }

        virtual property::Windows::UI::Xaml::Markup::IXamlType ^
        KeyType { ::Windows::UI::Xaml::Markup::IXamlType ^ get(); }
...
ref class XamlUserType sealed : public[ ::Platform::Metadata::RuntimeClassName] ::Windows::UI::Xaml::Markup::IXamlType {
    internal : XamlUserType(::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider ^ provider,
...
public:
    ...
    virtual property::Windows::UI::Xaml::Markup::IXamlMember ^ ContentProperty { ::Windows::UI::Xaml::Markup::IXamlMember ^ get(); }

        virtual property::Windows::UI::Xaml::Markup::IXamlType ^
        ItemType { ::Windows::UI::Xaml::Markup::IXamlType ^ get(); }
...
ref class XamlMember sealed : public ::Windows::UI::Xaml::Markup::IXamlMember {
    internal : XamlMember(::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider ^ provider,
...
public:
    ...
    virtual property::Platform::String ^ Name { ::Platform::String ^ get(); }
        ...
        virtual property::Windows::UI::Xaml::Markup::IXamlType ^
        Type { ::Windows::UI::Xaml::Markup::IXamlType ^ get(); }

        virtual property::Windows::UI::Xaml::Markup::IXamlType ^
        TargetType { ::Windows::UI::Xaml::Markup::IXamlType ^ get(); }
