...
static ComPtr<IDWriteTextFormat> _createDWriteTextFormat(_CTTypesetter* ts, CFRange range) {
    ...
    // TODO::
    // Get all attributed string ranges and use them to get font details.
...
static ComPtr<IDWriteTextLayout> _createDWriteTextLayout(_CTTypesetter* ts, CFRange range, CGRect frameSize) {
    ...
    */
    ...
    // TODO::
    // We need too support widthFunc semantic to be able to support NSLayout*. The API signature might have to change for this.
    //
