...
NSString* const CNContainerIdentifierKey = @"CNContainerIdentifierKey";
NSString* const CNContainerNameKey = @"CNContainerNameKey";
NSString* const CNContainerTypeKey = @"CNContainerTypeKey";
