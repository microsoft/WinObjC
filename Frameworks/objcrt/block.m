...
static struct objc_abi_class _NSConcreteStackBlock_metaclass =
    { (void*)"NSBlock", "NSBlock", "NSStackBlock", 8, OBJC_CLASS_INFO_METACLASS, sizeof(struct objc_abi_class), NULL, NULL };

struct objc_abi_class _NSConcreteStackBlockCls =
    { &_NSConcreteStackBlock_metaclass, "NSBlock", "NSStackBlock", 8, OBJC_CLASS_INFO_CLASS, sizeof(of_block_literal_t), NULL, NULL };
...
__declspec(allocate("_block_isa")) void* _NSConcreteStackBlockRealIsa = (void*)&_NSConcreteStackBlockCls;
__declspec(allocate("_block_isa")) struct winrt_isa _NSConcreteStackBlock = {
    {
...
static struct objc_abi_class _NSConcreteGlobalBlock_metaclass =
    { (void*)"NSBlock", "NSBlock", "NSGlobalBlock", 8, OBJC_CLASS_INFO_METACLASS, sizeof(struct objc_abi_class), NULL, NULL };

struct objc_abi_class _NSConcreteGlobalBlockCls =
    { &_NSConcreteGlobalBlock_metaclass, "NSBlock", "NSGlobalBlock", 8, OBJC_CLASS_INFO_CLASS, sizeof(of_block_literal_t), NULL, NULL };

__declspec(allocate("_block_isa")) void* _NSConcreteGlobalBlockRealIsa = (void*)&_NSConcreteGlobalBlockCls;
__declspec(allocate("_block_isa")) struct winrt_isa _NSConcreteGlobalBlock = {
    {
        (void*)_winrt_inspect_QueryInterface,
        (void*)_winrt_inspect_AddRef,
        (void*)_winrt_inspect_Release,
...
static struct objc_abi_class _NSConcreteMallocBlock_metaclass =
    { (void*)"NSBlock", "NSBlock", "NSMallocBlock", 8, OBJC_CLASS_INFO_METACLASS, sizeof(struct objc_abi_class), NULL, NULL };

struct objc_abi_class _NSConcreteMallocBlockCls =
    { &_NSConcreteMallocBlock_metaclass, "NSBlock", "NSMallocBlock", 8, OBJC_CLASS_INFO_CLASS, sizeof(of_block_literal_t), NULL, NULL };

__declspec(allocate("_block_isa")) void* _NSConcreteMallocBlockRealCls = (void*)&_NSConcreteMallocBlockCls;
__declspec(allocate("_block_isa")) struct winrt_isa _NSConcreteMallocBlock = {
    {
        (void*)_winrt_inspect_QueryInterface,
        (void*)_winrt_inspect_AddRef,
        (void*)_winrt_inspect_Release,
...
static struct {
    ...
    void* defs[4];
} symtab = { 0, NULL, 3, 0, { &_NSConcreteStackBlockCls, &_NSConcreteGlobalBlockCls, &_NSConcreteMallocBlockCls, NULL } };

static struct objc_abi_module module = { 8, sizeof(module), NULL, (struct objc_abi_symtab*) & symtab };
...
void* _Block_copy(const void* block_) {
...
OBJCRT_EXPORT void _Block_release(const void* block_) {
    of_block_literal_t* block = (of_block_literal_t*)block_;
...
OBJCRT_EXPORT void _Block_object_assign(void* dst_, const void* src_, const int flags_) {
    int flags = flags_ & (OF_BLOCK_FIELD_IS_BLOCK | OF_BLOCK_FIELD_IS_OBJECT | OF_BLOCK_FIELD_IS_BYREF);
...
OBJCRT_EXPORT void _Block_object_dispose(const void* obj_, const int flags_) {
    const int flags = flags_ & (OF_BLOCK_FIELD_IS_BLOCK | OF_BLOCK_FIELD_IS_OBJECT | OF_BLOCK_FIELD_IS_BYREF);
...
- (unsigned int)retainCount {
    if (object_getClass(self) == (Class)&_NSConcreteMallocBlockCls)
        return ((of_block_literal_t*)self)->flags & OF_BLOCK_REFCOUNT_MASK;
...
OBJCRT_EXPORT id objc_retainBlock(id block) {
