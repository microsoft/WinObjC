...
NSDictionary* _createFailureInfoDict(const wil::FailureInfo& fi) {
    id ret = [_LazyNSDictionary dictionaryWithObjectsAndKeys:[_LazyNSString stringWithUTF8String:fi.pszFile],
                                                             [_LazyNSString stringWithCString:"file"],
                                                             [_LazyNSString stringWithUTF8String:fi.pszFunction],
                                                             [_LazyNSString stringWithCString:"function"],
                                                             [_LazyNSNumber numberWithInt:fi.uLineNumber],
                                                             [_LazyNSString stringWithCString:"line"],
                                                             [_LazyNSNumber numberWithInt:fi.hr],
                                                             [_LazyNSString stringWithCString:"hresult"],
                                                             nil];
...
unsigned long objc_formatMessageW(unsigned long flags,
                                  const void* source,
