...
@implementation UIDevice : NSObject
    ...
    /* annotate with type */ -(void) setBatteryMonitoringEnabled:(BOOL)enable {
    ...
    /* annotate with type */ -(id) setProximityMonitoringEnabled:(DWORD)enable {
        return self;
    }

    /* annotate with type */ -(id) setOrientation:(UIDeviceOrientation)orientation {
        return [self setOrientation:orientation animated:TRUE];
    }

    /* annotate with type */ -(id) setOrientation:(UIDeviceOrientation)orientation animated:(BOOL)animated {
    ...
    /* annotate with type */ -(id) playInputClick {
        return self;
    }       
