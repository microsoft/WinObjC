...
@implementation UIDatePicker {
    ...
    static void setDate(UIDatePicker *self, NSDate *date, BOOL animated = FALSE)
    {
        ...
        NSDateComponents *components = [calendar components:NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit fromDate:(NSDate *) self->_date];
    ...
    -(NSDate *) date {
        if ( _date == nil ) {
            _date = [NSDate date];
            NSCalendar *calendar = [NSCalendar currentCalendar];
            NSDateComponents *components = [calendar components:NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit fromDate:(NSDate *) _date];
    ...
    static void didSelectDateAndTime(UIDatePicker *self, int row, int component)
    {
        ...
        NSDateComponents *components = [calendar components:NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit fromDate:(id) daySelected];
    ...
    {
        NSCalendar *calendar = [NSCalendar currentCalendar];
        NSDateComponents *diffDate = [calendar components:NSHourCalendarUnit | NSMinuteCalendarUnit fromDate:(NSDate *) self->_minimumDate toDate:(NSDate *) self->_maximumDate options:0];
    ...
    static NSString *titleForDateRow(UIDatePicker *self, unsigned row, int component, id *color)
    {
        id ret = nil;
        NSCalendar *calendar = [NSCalendar currentCalendar];
        NSDateComponents *components = [calendar components:NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit fromDate:(id) self->_date];
    ...
    static id titleForTimeRow(UIDatePicker *self, int row, int component, UIColor **color)
    {
        ...
        NSCalendar *calendar = [NSCalendar currentCalendar];
        NSDateComponents *components = [calendar components:NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit fromDate:(NSDate *) self->_date];
        int hour = [components hour];
    ...
    static NSString *titleForDayRow(UIDatePicker *self, int row)
    {
        ...
        NSDateComponents *retDateComponents = [calendar components:NSDayCalendarUnit | NSMonthCalendarUnit | NSWeekdayCalendarUnit fromDate:retDate];
