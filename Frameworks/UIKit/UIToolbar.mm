...
@implementation UIToolbar {
    ...
    -(instancetype) initWithCoder:(NSCoder *)coder {
        ...
        switch ( _style ) {
            case 1:
                _backgroundGradient = [[UIImage imageNamed:@"/img/navgradient-blackopaque.png"] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
                break;

            case 2:
            case 3:
                _backgroundGradient = [[UIImage imageNamed:@"/img/navgradient-blacktranslucent.png"] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
                break;
    ...
    void layoutItems(UIToolbar *self)
    {
        ...
        for ( i = 0; i < count; i ++ ) {
            ...
            if ( [curButton isFlexibleWidth] ) {
                ...
                if ( curContainer ) curContainer->width = curWidth;
            }
        }
        ...
        if ( viewGroups.size() > 0 ) {
            ...
            if ( flexibleWidth < 0 ) flexibleWidth = 0;
