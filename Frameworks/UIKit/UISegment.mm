...
@implementation UISegment : UIView
    /* annotate with type */ +(id) initialize {
        ...
        _buttonRight[0] = [[UIImage imageNamed:@"/img/ButtonBarRightNoSelect@2x.png"] resizableImageWithCapInsets: UIEdgeInsetsMake(0, 10, 0, 10)];
