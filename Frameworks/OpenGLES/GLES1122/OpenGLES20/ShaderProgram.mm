...
#ifdef WINPHONE
extern "C" DWORD glLinkProgram(GLuint program);
#endif
...
void ShaderProgram::setAttributeVertexPointer(
    GLuint location, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void* pointer) {
