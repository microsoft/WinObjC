...
static ShaderFile files[] = {
    "alphaTest.frag", NAMESIZE(alphaTest_frag),
    "clipPlane.frag", NAMESIZE(clipPlane_frag),
    "clipPlane.vert", NAMESIZE(clipPlane_vert),
    "fog.glsl", NAMESIZE(fog_glsl),
    "lighting.frag", NAMESIZE(lighting_frag),
    "lighting.vert", NAMESIZE(lighting_vert),
    "lightingPerFragment.frag", NAMESIZE(lightingPerFragment_frag),
    "lightingPerFragment.vert", NAMESIZE(lightingPerFragment_vert),
    "lightingPerVertex.vert", NAMESIZE(lightingPerVertex_vert),
    "main.frag", NAMESIZE(main_frag),
    "main.vert", NAMESIZE(main_vert),
    "postprocess.frag", NAMESIZE(postprocess_frag),
    "postprocess.vert", NAMESIZE(postprocess_vert),
    "texture.frag", NAMESIZE(texture_frag),
    "texture.vert", NAMESIZE(texture_vert),
    "texture0.frag", NAMESIZE(texture0_frag),
    "texture0.vert", NAMESIZE(texture0_vert),
    "texture1.frag", NAMESIZE(texture1_frag),
    "texture1.vert", NAMESIZE(texture1_vert),
    "texture2.frag", NAMESIZE(texture2_frag),
    "texture2.vert", NAMESIZE(texture2_vert)
};
...
int OpenGLESFile::seek(long int offset, int origin)
{
    ...
    if ( buf_pos > buf_len ) buf_pos = buf_len;
...
size_t OpenGLESFile::read(void *ptr, size_t size, size_t count)
{
    ...
    if ( left < bytesToRead ) bytesToRead = left;
