...
EAGL_EXPORT void EXPORT_glEnable(GLenum cap)
{
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glEnable(cap);
    }
}
...
EAGL_EXPORT void EXPORT_glDisable(GLenum cap)
{
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glDisable(cap);
    }
}
...
EAGL_EXPORT void EXPORT_glActiveTexture(GLenum texture)
{
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glActiveTexture(texture);
    }
}

EAGL_EXPORT void EXPORT_glMatrixMode(GLenum mode)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glMatrixMode(mode);
}

EAGL_EXPORT void EXPORT_glLoadIdentity()
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glLoadIdentity();
}

EAGL_EXPORT void EXPORT_glFrustumf(float left, float right, float bottom, float top, float zNear, float zFar)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glFrustumf(left, right, bottom, top, zNear, zFar);
}

EAGL_EXPORT void EXPORT_glMultMatrixf(const GLfloat *m)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glMultMatrixf(m);
}

EAGL_EXPORT void EXPORT_glTranslatef (float x, float y, float z)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glTranslatef(x, y, z);
}

EAGL_EXPORT void EXPORT_glRotatef (float angle, float x, float y, float z)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glRotatef(angle, x, y, z);
}

EAGL_EXPORT void EXPORT_glScalef(float x, float y, float z)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glScalef(x, y, z);
}

EAGL_EXPORT void EXPORT_glMaterialf(GLenum face, GLenum pname, GLfloat param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glMaterialf(face, pname, param);
}

EAGL_EXPORT void EXPORT_glMaterialfv(GLenum face, GLenum pname, const GLfloat *params)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glMaterialfv(face, pname, params);
}

EAGL_EXPORT void EXPORT_glMaterialx(GLenum face, GLenum pname, GLfixed param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glMaterialx(face, pname, param);
}

EAGL_EXPORT void EXPORT_glMaterialxv(GLenum face, GLenum pname, const GLfixed *params)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glMaterialxv(face, pname, params);
}

EAGL_EXPORT void EXPORT_glOrthof(float left, float right, float bottom, float top, float zNear, float zFar)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glOrthof(left, right, bottom, top, zNear, zFar);
}

EAGL_EXPORT void EXPORT_glPushMatrix()
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glPushMatrix();
}

EAGL_EXPORT void EXPORT_glPopMatrix()
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glPopMatrix();
}

EAGL_EXPORT void EXPORT_glEnableClientState(GLenum cap)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glEnableClientState(cap);
}

EAGL_EXPORT void EXPORT_glDisableClientState(GLenum cap)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glDisableClientState(cap);
}

EAGL_EXPORT void EXPORT_glVertexPointer (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glVertexPointer(size, type, stride, pointer);
}

EAGL_EXPORT void EXPORT_glTexCoordPointer (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glTexCoordPointer(size, type, stride, pointer);
}

EAGL_EXPORT void EXPORT_glColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glColorPointer(size, type, stride, pointer);
}

EAGL_EXPORT void EXPORT_glNormalPointer(GLenum type, GLsizei stride, const GLvoid *pointer)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glNormalPointer(type, stride, pointer);
}

EAGL_EXPORT void EXPORT_glTexEnvf(GLenum target, GLenum pname, float param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glTexEnvf(target, pname, param);
}

EAGL_EXPORT void EXPORT_glTexEnvfv(GLenum target, GLenum pname, GLfloat *param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glTexEnvfv(target, pname, param);
}

EAGL_EXPORT void EXPORT_glTexEnvi(GLenum target, GLenum pname, GLint param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glTexEnvi(target, pname, param);
}

EAGL_EXPORT void EXPORT_glColor4f(float r, float g, float b, float a)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glColor4f(r, g, b, a);
}

EAGL_EXPORT void EXPORT_glColor4ub(GLubyte r, GLubyte g, GLubyte b, GLubyte a)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glColor4ub(r, g, b, a);
}

EAGL_EXPORT void EXPORT_glPointSizePointerOES(GLenum type, GLsizei stride, const GLvoid * pointer)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glPointSizePointerOES(type, stride, pointer);
}

EAGL_EXPORT void EXPORT_glPointSize(GLfloat size)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glPointSize(size);
}

EAGL_EXPORT void EXPORT_glShadeModel(GLenum model)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glShadeModel(model);
}

EAGL_EXPORT void EXPORT_glLightf(GLenum light, GLenum name, float param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glLightf(light, name, param);
}

EAGL_EXPORT void EXPORT_glLightfv(GLenum light, GLenum name, GLfloat *params)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glLightfv(light, name, params);
}

EAGL_EXPORT void EXPORT_glClientActiveTexture(GLenum texture)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glClientActiveTexture(texture);
}

EAGL_EXPORT void EXPORT_glAlphaFunc(GLenum func, GLfloat ref)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glAlphaFunc(func, ref);
}

EAGL_EXPORT void EXPORT_glLoadMatrixf(const GLfloat * m)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glLoadMatrixf(m);
}

EAGL_EXPORT void EXPORT_glFogfv(GLenum pname, const GLfloat * params)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glFogfv(pname, params);
}

EAGL_EXPORT void EXPORT_glFogf(GLenum pname, float param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glFogf(pname, param);
}

EAGL_EXPORT void EXPORT_glFogx(GLenum pname, GLfixed param)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glFogx(pname, param);
}

EAGL_EXPORT void EXPORT_glNormal3f(GLfloat nx, GLfloat ny, GLfloat nz)
{
    if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glNormal3f(nx, ny, nz);
}
...
EAGL_EXPORT void EXPORT_glBindTexture(GLenum target, GLuint texture)
{
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glBindTexture(target, texture);
    }
}
...
EAGL_EXPORT void EXPORT_glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels)
{
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels);
    } else {
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels);
    }
}

EAGL_EXPORT void EXPORT_glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels)
{
    glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels);
}

EAGL_EXPORT void EXPORT_glCompressedTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *pixels)
{
...
{   
    ...
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glDrawArrays(mode, first, count);
    }
}
...
{   
    ...
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glDrawElements(mode, count, type, indices);
    }
}
...
EAGL_EXPORT void EXPORT_glGetFloatv(GLenum pname, GLfloat *params)
{
    if ( !tlsCurContext || !tlsCurContext->_gl11Ctx ) {
        ...
        if ( tlsCurContext && tlsCurContext->_gl11Ctx ) tlsCurContext->_gl11Ctx->glGetFloatv(pname, params);
    }
}
...
EAGL_EXPORT void EXPORT_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border)
{
    glCopyTexImage2D(target, level, internalformat, x, y, width, height, border);
}

EAGL_EXPORT void EXPORT_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
...
EAGL_EXPORT void EXPORT_glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufsize, GLsizei *length,
                         GLint *size, GLenum *type, GLchar *name)
{
    glGetActiveAttrib(program, index, bufsize, length, size, type, name);
}

EAGL_EXPORT void EXPORT_glGetActiveUniform(GLuint program, GLuint index, GLsizei bufsize, GLsizei *length,
                          GLint *size, GLenum *type, GLchar *name)
{
...
EAGL_EXPORT void EXPORT_glGetShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype, GLint *range,
                                  GLint *precision)
{
...
EAGL_EXPORT void EXPORT_glShaderBinary(GLsizei n, const GLuint *shaders, GLenum binaryformat,
...
EAGL_EXPORT void EXPORT_glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose,
                          const GLfloat *value)
{
    glUniformMatrix2fv(location, count, transpose, value);
}

EAGL_EXPORT void EXPORT_glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose,
                          const GLfloat *value)
{
    glUniformMatrix3fv(location, count, transpose, value);
}

EAGL_EXPORT void EXPORT_glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose,
                          const GLfloat *value)
{
...
EAGL_EXPORT void EXPORT_glVertexAttribPointer(GLuint indx, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid* ptr)
{
