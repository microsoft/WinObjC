...
@implementation CATransaction {
    ...
    {
        GetCACompositor()->addNode([self _currentTransaction]->_transactionQueue, sublayer->priv->_presentationNode, layer->priv->_presentationNode, NULL, NULL);
    }

    +(void) _addSublayerToLayer: (CALayer *) layer sublayer: (CALayer *) sublayer before: (CALayer *) before
    {
        GetCACompositor()->addNode([self _currentTransaction]->_transactionQueue, sublayer->priv->_presentationNode, layer->priv->_presentationNode, before->priv->_presentationNode, NULL);
    }

    +(void) _addSublayerToLayer: (CALayer *) layer sublayer: (CALayer *) sublayer after: (CALayer *) after
    {
        GetCACompositor()->addNode([self _currentTransaction]->_transactionQueue, sublayer->priv->_presentationNode, layer->priv->_presentationNode, NULL, after->priv->_presentationNode);
    }

    +(void) _replaceInLayer: (CALayer *) layer sublayer: (CALayer *) sublayer withSublayer: (CALayer *) newlayer
    {
        GetCACompositor()->addNode([self _currentTransaction]->_transactionQueue, newlayer->priv->_presentationNode, layer->priv->_presentationNode, sublayer->priv->_presentationNode, NULL);
    ...
    {
        GetCACompositor()->moveNode([self _currentTransaction]->_transactionQueue, layer->priv->_presentationNode, before ? before->priv->_presentationNode : NULL, after ? after->priv->_presentationNode : NULL);
    }
