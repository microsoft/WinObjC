...
private:
    struct  ChannelState
    {
        ...
        inline void Reset() { mPredictedSample = 0; mStepTableIndex = 0; }
    };
    ...
    void    DecodeChannelSInt16(ChannelState& ioChannelState, UInt32 inNumberChannels, UInt32 inDecodeChannel, UInt32 inNumberPacketsToDecode, const Byte* inInputData, SInt16* outOutputData);

    // CAF File Header
    enum {
        _port_CAF_FileType              = 'caff',
        CAF_FileVersion_Initial = 1
    };
    ...
    UInt32  ProduceOutputPackets(EbrFile *fpIn, ChannelStateList &mChannelStateList, void* outOutputData, UInt32& ioOutputDataByteSize, UInt32& ioNumberPackets, OutputDescription &mOutputFormat, CAFAudioDescription &mInputFormat);
    EbrFile *fpIn;
