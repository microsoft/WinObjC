...
*/
    ...
    */
	...
	// [jms] Just default to en_US in Windows Phone because the C Locale APIs have been deprecated.
	return "en_US";
...
#elif defined(_WINPHONE)
	// This seems to be the default fallback codepage. We can't get ANSI codepages in
	// winphone because those are lies and UTF16 is the only truth.
	return "US-ASCII";
