...
GLboolean RenderbufferInterface::shouldMirrorVertically() const
{
	return false;
}
...
GLboolean Renderbuffer::shouldMirrorVertically() const
{
	return mInstance->shouldMirrorVertically();
}
...
Colorbuffer::Colorbuffer(rx::RenderTarget *target)
{
...
{
	//mirrorVertically = true;  [BL: not needed anymore]
	mirrorVertically = false;
...
GLboolean Colorbuffer::shouldMirrorVertically() const
{
