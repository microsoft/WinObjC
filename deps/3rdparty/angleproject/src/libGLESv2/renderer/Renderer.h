...
class Renderer
{
  public:
    ...
    virtual void unapplyRenderTargets() = 0;
    ...
    virtual TextureStorage *createTextureStorage2D(int levels, GLenum internalformat, GLenum usage, bool forceRenderable, GLsizei width, GLsizei height, void *directData) = 0;
