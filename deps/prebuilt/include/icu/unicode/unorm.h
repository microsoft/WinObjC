 ...
 * @deprecated ICU 56 Use unorm2.h instead.
 */
U_STABLE int32_t U_EXPORT2 unorm_normalize(const UChar* source,
 ...
 * @deprecated ICU 56 Use unorm2.h instead.
 */
U_STABLE UNormalizationCheckResult U_EXPORT2 unorm_quickCheck(const UChar* source,
                                                              int32_t sourcelength,
                                                              UNormalizationMode mode,
                                                              UErrorCode* status);
...
unorm_isNormalizedWithOptions(const UChar* src, int32_t srcLength, UNormalizationMode mode, int32_t options, UErrorCode* pErrorCode);
 ...
 * @deprecated ICU 56 Use unorm2.h instead.
 */
U_STABLE int32_t U_EXPORT2 unorm_next(UCharIterator* src,
                                      UChar* dest,
 ...
 * @deprecated ICU 56 Use unorm2.h instead.
 */
U_STABLE int32_t U_EXPORT2 unorm_previous(UCharIterator* src,
                                          UChar* dest,
                                          int32_t destCapacity,
                                          UNormalizationMode mode,
                                          int32_t options,
 ...
 * @deprecated ICU 56 Use unorm2.h instead.
 */
U_STABLE int32_t U_EXPORT2 unorm_concatenate(const UChar* left,
                                             int32_t leftLength,
                                             const UChar* right,
                                             int32_t rightLength,
                                             UChar* dest,
