 ...
 * @stable ICU 55
 */
U_STABLE UListFormatter* U_EXPORT2 ulistfmt_open(const char* locale, UErrorCode* status);
 ...
 * @stable ICU 55
 */
U_STABLE void U_EXPORT2 ulistfmt_close(UListFormatter* listfmt);
 ...
 * @stable ICU 55
 */
U_DRAFT int32_t U_EXPORT2 ulistfmt_format(const UListFormatter* listfmt,
