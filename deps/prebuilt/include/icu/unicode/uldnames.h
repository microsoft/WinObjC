 ...
 * @stable ICU 4.4
 */
U_STABLE ULocaleDisplayNames* U_EXPORT2 uldn_open(const char* locale, UDialectHandling dialectHandling, UErrorCode* pErrorCode);
 ...
 * @stable ICU 4.4
 */
U_STABLE int32_t U_EXPORT2 uldn_scriptCodeDisplayName(
 ...
 * @stable ICU 4.4
 */
U_STABLE int32_t U_EXPORT2 uldn_keyValueDisplayName(
...
* @stable ICU 51
*/
U_STABLE ULocaleDisplayNames* U_EXPORT2 uldn_openForContext(const char* locale,
...
* @stable ICU 51
*/
U_STABLE UDisplayContext U_EXPORT2 uldn_getContext(const ULocaleDisplayNames* ldn, UDisplayContextType type, UErrorCode* pErrorCode);
