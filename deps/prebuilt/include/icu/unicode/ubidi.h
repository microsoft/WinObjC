...
ubidi_setContext(UBiDi* pBiDi, const UChar* prologue, int32_t proLength, const UChar* epilogue, int32_t epiLength, UErrorCode* pErrorCode);
 ...
 */
U_STABLE void U_EXPORT2
ubidi_setPara(UBiDi* pBiDi, const UChar* text, int32_t length, UBiDiLevel paraLevel, UBiDiLevel* embeddingLevels, UErrorCode* pErrorCode);
 ...
 * @stable ICU 4.6
 */
U_STABLE UBiDiDirection U_EXPORT2 ubidi_getBaseDirection(const UChar* text, int32_t length);
 ...
 * @stable ICU 3.4
 */
U_STABLE int32_t U_EXPORT2 ubidi_getParagraph(
 ...
 * @stable ICU 3.4
 */
U_STABLE void U_EXPORT2 ubidi_getParagraphByIndex(
 ...
 * @stable ICU 2.0
 */
U_STABLE const UBiDiLevel* U_EXPORT2 ubidi_getLevels(UBiDi* pBiDi, UErrorCode* pErrorCode);
 ...
 * @stable ICU 3.6
 */
U_STABLE UCharDirection U_EXPORT2 ubidi_getCustomizedClass(UBiDi* pBiDi, UChar32 c);
...
ubidi_writeReverse(const UChar* src, int32_t srcLength, UChar* dest, int32_t destSize, uint16_t options, UErrorCode* pErrorCode);
