 ...
 * @stable ICU 52
 */
U_STABLE UFormattableType U_EXPORT2 ufmt_getType(const UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE UDate U_EXPORT2 ufmt_getDate(const UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE double U_EXPORT2 ufmt_getDouble(UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE int32_t U_EXPORT2 ufmt_getLong(UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE int64_t U_EXPORT2 ufmt_getInt64(UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE const void* U_EXPORT2 ufmt_getObject(const UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE const UChar* U_EXPORT2 ufmt_getUChars(UFormattable* fmt, int32_t* len, UErrorCode* status);
 ...
 */
U_STABLE int32_t U_EXPORT2 ufmt_getArrayLength(const UFormattable* fmt, UErrorCode* status);
 ...
 */
U_STABLE UFormattable* U_EXPORT2 ufmt_getArrayItemByIndex(UFormattable* fmt, int32_t n, UErrorCode* status);
 ...
 * @return the character buffer as a NULL terminated string, which is owned by the object and must not be accessed if any other functions
 * are called on this object.
 * @stable ICU 52
 * @see icu::Formattable::getDecimalNumber(UErrorCode&)
 */
U_STABLE const char* U_EXPORT2 ufmt_getDecNumChars(UFormattable* fmt, int32_t* len, UErrorCode* status);
