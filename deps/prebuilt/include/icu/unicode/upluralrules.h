 ...
 * @stable ICU 4.8
 */
U_STABLE UPluralRules* U_EXPORT2 uplrules_open(const char* locale, UErrorCode* status);
 ...
 * @stable ICU 50
 */
U_DRAFT UPluralRules* U_EXPORT2 uplrules_openForType(const char* locale, UPluralType type, UErrorCode* status);
 ...
 * @stable ICU 4.8
 */
U_STABLE void U_EXPORT2 uplrules_close(UPluralRules* uplrules);
...
uplrules_select(const UPluralRules* uplrules, double number, UChar* keyword, int32_t capacity, UErrorCode* status);
