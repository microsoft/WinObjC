...
#define U8_COUNT_TRAIL_BYTES(leadByte)                                                            \
    ((uint8_t)(leadByte) < 0xf0 ? ((uint8_t)(leadByte) >= 0xc0) + ((uint8_t)(leadByte) >= 0xe0) : \
...
#define U8_LENGTH(c)                                                                                                         \
    ((uint32_t)(c) <= 0x7f ?                                                                                                 \
         1 :                                                                                                                 \
         ((uint32_t)(c) <= 0x7ff ? 2 : ((uint32_t)(c) <= 0xd7ff ? 3 : ((uint32_t)(c) <= 0xdfff || (uint32_t)(c) > 0x10ffff ? \
                                                                           0 :                                               \
    ...
    {                                                                                                                                 \
        ...
        if ((c) >= 0x80) {                                                                                                            \
            ...
            if (/* handle U+1000..U+CFFF inline */                                                                                    \
                (0xe0 < (c) && (c) <= 0xec) && (((i) + 1) < (length) || (length) < 0) && (__t1 = (uint8_t)((s)[i] - 0x80)) <= 0x3f && \
