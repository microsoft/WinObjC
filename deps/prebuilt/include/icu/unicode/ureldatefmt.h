 ...
 * @draft ICU 57
 */
U_DRAFT URelativeDateTimeFormatter* U_EXPORT2 ureldatefmt_open(const char* locale,
 ...
 * @draft ICU 57
 */
U_DRAFT void U_EXPORT2 ureldatefmt_close(URelativeDateTimeFormatter* reldatefmt);
 ...
 * @draft ICU 57
 */
U_DRAFT int32_t U_EXPORT2 ureldatefmt_formatNumeric(const URelativeDateTimeFormatter* reldatefmt,
                                                    double offset,
 ...
 * @draft ICU 57
 */
U_DRAFT int32_t U_EXPORT2 ureldatefmt_format(const URelativeDateTimeFormatter* reldatefmt,
                                             double offset,
                                             URelativeDateTimeUnit unit,
                                             UChar* result,
                                             int32_t resultCapacity,
 ...
 * @draft ICU 57
 */
U_DRAFT int32_t U_EXPORT2 ureldatefmt_combineDateAndTime(const URelativeDateTimeFormatter* reldatefmt,
