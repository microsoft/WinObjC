 ...
 * @stable ICU 4.2
 */
U_STABLE USpoofChecker* U_EXPORT2 uspoof_openFromSerialized(const void* data,
                                                            int32_t length,
...
/**
  ...
  * @stable ICU 4.2
  */
U_STABLE USpoofChecker* U_EXPORT2 uspoof_openFromSource(const char* confusables,
...
uspoof_areConfusable(const USpoofChecker* sc, const UChar* id1, int32_t length1, const UChar* id2, int32_t length2, UErrorCode* status);
 ...
 */
U_STABLE int32_t U_EXPORT2
uspoof_areConfusableUTF8(const USpoofChecker* sc, const char* id1, int32_t length1, const char* id2, int32_t length2, UErrorCode* status);
...
/**
  ...
  * @stable ICU 4.2
  */
U_STABLE int32_t U_EXPORT2 uspoof_getSkeleton(
...
/**
  ...
  * @stable ICU 4.2
  */
U_STABLE int32_t U_EXPORT2 uspoof_getSkeletonUTF8(
