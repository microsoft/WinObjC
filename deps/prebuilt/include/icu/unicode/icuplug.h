 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setPlugNoUnload(UPlugData* plug, UBool dontUnload);
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setPlugLevel(UPlugData* plug, UPlugLevel level);
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_setPlugName(UPlugData* plug, const char* name);
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL const char* U_EXPORT2 uplug_getLibraryName(UPlugData* plug, UErrorCode* status);
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL UPlugData* U_EXPORT2 uplug_loadPlugFromEntrypoint(UPlugEntrypoint* entrypoint, const char* config, UErrorCode* status);
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL UPlugData* U_EXPORT2 uplug_loadPlugFromLibrary(const char* libName, const char* sym, const char* config, UErrorCode* status);
 ...
 * @internal ICU 4.4 Technology Preview
 */
U_INTERNAL void U_EXPORT2 uplug_removePlug(UPlugData* plug, UErrorCode* status);
