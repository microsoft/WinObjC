 ...
 * @stable ICU 52
 */
U_STABLE UNumberingSystem* U_EXPORT2 unumsys_open(const char* locale, UErrorCode* status);
 ...
 * @stable ICU 52
 */
U_STABLE UNumberingSystem* U_EXPORT2 unumsys_openByName(const char* name, UErrorCode* status);
 ...
 * @stable ICU 52
 */
U_STABLE UEnumeration* U_EXPORT2 unumsys_openAvailableNames(UErrorCode* status);
 ...
 * @stable ICU 52
 */
U_STABLE const char* U_EXPORT2 unumsys_getName(const UNumberingSystem* unumsys);
 ...
 * @stable ICU 52
 */
U_STABLE UBool U_EXPORT2 unumsys_isAlgorithmic(const UNumberingSystem* unumsys);
 ...
 * @stable ICU 52
 */
U_STABLE int32_t U_EXPORT2 unumsys_getDescription(const UNumberingSystem* unumsys, UChar* result, int32_t resultLength, UErrorCode* status);
