...
private:
    ...
    static inline int32_t getArgumentLimit(const UChar* compiledPattern, int32_t compiledPatternLength) {
    ...
    static UnicodeString& format(const UChar* compiledPattern,
