 ...
 * @stable ICU 3.8
 */
U_STABLE int32_t U_EXPORT2 udatpg_getBestPattern(
...
/**
  ...
  * @stable ICU 3.8
  */
U_STABLE int32_t U_EXPORT2 udatpg_getSkeleton(
 ...
 * @stable ICU 3.8
 */
U_STABLE int32_t U_EXPORT2 udatpg_getBaseSkeleton(UDateTimePatternGenerator* unusedDtpg,
                                                  const UChar* pattern,
                                                  int32_t length,
                                                  UChar* baseSkeleton,
                                                  int32_t capacity,
