...
{
    internal class ScrollViewHandler : ViewHandler
    {
        internal new static List<XamlDomObject> CreateObject(XElement tag, XamlSchemaContext schema)
        {
            ...
            var scrollViewer = new XamlDomObject(schema.GetXamlType(typeof(ScrollViewer)));

            SetCommonProperties(tag, scrollViewer);
            domObjects.Add(scrollViewer);
