...
struct dispatch_source_s {
    ...
    union {
        ...
        struct {
            ...
            unsigned int ds_is_level : 1, ds_is_adder : 1, ds_is_installed : 1, ds_needs_rearm : 1, ds_is_armed : 1, ds_is_legacy : 1,
                ds_cancel_is_block : 1, ds_handler_is_block : 1;
...
struct dispatch_source_type_s {
    void* opaque;
    uint64_t mask;
    bool (*init)(dispatch_source_t ds, dispatch_source_type_t type, uintptr_t handle, uintptr_t mask, dispatch_queue_t q);
};
