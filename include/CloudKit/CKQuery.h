...
- (instancetype)initWithRecordType:(NSString*)recordType predicate:(NSPredicate*)predicate STUB_METHOD;
...
@property (copy, nonatomic) NSArray* sortDescriptors STUB_PROPERTY;
@end
