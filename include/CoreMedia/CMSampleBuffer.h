...
SB_EXPORT Boolean CMSampleBufferIsValid(CMSampleBufferRef sbuf);
SB_EXPORT Boolean CMSampleBufferDataIsReady(CMSampleBufferRef sbuf);

#endif /* _CMSAMPLEBUFFER_H_ */