...
@property (readwrite, nonatomic) ABRecordRef parentGroup STUB_PROPERTY;

@property (assign, nonatomic) id<ABNewPersonViewControllerDelegate> newPersonViewDelegate STUB_PROPERTY;
// Manually redeclare the getter here to bypass restrictions on 'new' in function names
