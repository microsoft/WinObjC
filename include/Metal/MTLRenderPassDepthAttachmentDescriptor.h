...
METAL_EXPORT_CLASS
@interface MTLRenderPassDepthAttachmentDescriptor : MTLRenderPassAttachmentDescriptor <NSCopying>

@property (nonatomic) double clearDepth STUB_PROPERTY;
@property (nonatomic) MTLMultisampleDepthResolveFilter depthResolveFilter STUB_PROPERTY;
