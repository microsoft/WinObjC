...
- (void)addService:(HMService*)service completionHandler:(void (^)(NSError*))completion STUB_METHOD;
- (void)removeService:(HMService*)service completionHandler:(void (^)(NSError*))completion STUB_METHOD;
@end
