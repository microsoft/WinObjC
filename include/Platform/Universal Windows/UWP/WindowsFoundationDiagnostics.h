...
- (void)addUInt8ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* uint8_t */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addInt16ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* int16_t */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addUInt16ArrayWithFormat:(NSString *)name value:(id<NSFastEnumeration> /* unsigned short */)value format:(WFDLoggingFieldFormat)format;
- (void)addUInt16ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* unsigned short */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addInt32ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* int */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addUInt32ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* unsigned int */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addInt64ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* int64_t */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addUInt64ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* uint64_t */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addSingleArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* float */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addChar16ArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* WCHAR */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addBooleanArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* BOOL */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addStringArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* NSString * */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
...
- (void)addGuidArrayWithFormatAndTags:(NSString *)name value:(id<NSFastEnumeration> /* WFGUID* */)value format:(WFDLoggingFieldFormat)format tags:(int)tags;
