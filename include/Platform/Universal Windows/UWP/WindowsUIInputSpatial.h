...
#ifndef OBJCUWP_WINDOWS_UI_INPUT_SPATIAL_EXPORT
#define OBJCUWP_WINDOWS_UI_INPUT_SPATIAL_EXPORT __declspec(dllimport)
#ifndef IN_OBJCUWP_BUILD
#pragma comment(lib, "ObjCUWP_Windows_UI_Input_Spatial.lib")
#endif
#endif
