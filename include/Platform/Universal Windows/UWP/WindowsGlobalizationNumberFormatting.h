...
+ (instancetype)create ACTIVATOR;
+ (WGNDecimalFormatter*)createDecimalFormatter:(id<NSFastEnumeration> /* NSString * */)languages geographicRegion:(NSString *)geographicRegion ACTIVATOR;
@property BOOL isDecimalPointAlwaysDisplayed;
@property int integerDigits;
@property BOOL isGrouped;
@property int fractionDigits;
...
+ (instancetype)create ACTIVATOR;
+ (WGNPercentFormatter*)createPercentFormatter:(id<NSFastEnumeration> /* NSString * */)languages geographicRegion:(NSString *)geographicRegion ACTIVATOR;
@property BOOL isDecimalPointAlwaysDisplayed;
@property int integerDigits;
@property BOOL isGrouped;
@property int fractionDigits;
...
+ (WGNPermilleFormatter*)createPermilleFormatter:(id<NSFastEnumeration> /* NSString * */)languages geographicRegion:(NSString *)geographicRegion ACTIVATOR;
+ (instancetype)create ACTIVATOR;
@property BOOL isDecimalPointAlwaysDisplayed;
@property int integerDigits;
@property BOOL isGrouped;
...
+ (WGNCurrencyFormatter*)createCurrencyFormatterCodeContext:(NSString *)currencyCode languages:(id<NSFastEnumeration> /* NSString * */)languages geographicRegion:(NSString *)geographicRegion ACTIVATOR;
