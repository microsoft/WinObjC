...
@class WSEEasClientDeviceInformation, WSEEasComplianceResults, WSEEasClientSecurityPolicy;
@protocol WSEIEasClientDeviceInformation, WSEIEasClientDeviceInformation2, WSEIEasClientSecurityPolicy, WSEIEasComplianceResults, WSEIEasComplianceResults2;
...
@property (retain) WFTimeSpan* passwordExpiration;
...
@property (retain) WFTimeSpan* maxInactivityTimeLock;
