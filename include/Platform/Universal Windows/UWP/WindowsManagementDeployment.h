...
@protocol WMDIDeploymentResult, WMDIPackageUserInformation, WMDIPackageManager, WMDIPackageManager2, WMDIPackageManager3, WMDIPackageVolume;
...
- (NSMutableArray*)findPackagesByNamePublisherWithPackagesTypes:(WMDPackageTypes)packageTypes packageName:(NSString *)packageName packagePublisher:(NSString *)packagePublisher;
- (NSMutableArray*)findPackagesByPackageFamilyNameWithPackageTypes:(WMDPackageTypes)packageTypes packageFamilyName:(NSString *)packageFamilyName;
...
- (NSMutableArray*)findPackagesByUserSecurityIdNamePublisher:(NSString *)userSecurityId packageName:(NSString *)packageName packagePublisher:(NSString *)packagePublisher;
...
- (NSMutableArray*)findPackagesByUserSecurityIdNamePublisherWithPackageTypes:(NSString *)userSecurityId packageTypes:(WMDPackageTypes)packageTypes packageName:(NSString *)packageName packagePublisher:(NSString *)packagePublisher;
- (NSMutableArray*)findPackagesByUserSecurityIdPackageFamilyNameWithPackagesTypes:(NSString *)userSecurityId packageTypes:(WMDPackageTypes)packageTypes packageFamilyName:(NSString *)packageFamilyName;
...
- (id<NSFastEnumeration>)findPackagesByUserSecurityIdNamePublisher:(NSString *)userSecurityId packageName:(NSString *)packageName packagePublisher:(NSString *)packagePublisher;
...
- (id<NSFastEnumeration>)findPackagesByUserSecurityIdPackageFamilyName:(NSString *)userSecurityId packageFamilyName:(NSString *)packageFamilyName;
...
- (id<NSFastEnumeration>)findPackagesByNamePublisherWithPackageTypes:(NSString *)packageName packagePublisher:(NSString *)packagePublisher packageTypes:(WMDPackageTypes)packageTypes;
- (id<NSFastEnumeration>)findPackagesByUserSecurityIdNamePublisherWithPackageTypes:(NSString *)userSecurityId packageName:(NSString *)packageName packagePublisher:(NSString *)packagePublisher packageTypes:(WMDPackageTypes)packageTypes;
- (id<NSFastEnumeration>)findPackagesByPackageFamilyNameWithPackageTypes:(NSString *)packageFamilyName packageTypes:(WMDPackageTypes)packageTypes;
- (id<NSFastEnumeration>)findPackagesByUserSecurityIdPackageFamilyNameWithPackageTypes:(NSString *)userSecurityId packageFamilyName:(NSString *)packageFamilyName packageTypes:(WMDPackageTypes)packageTypes;
