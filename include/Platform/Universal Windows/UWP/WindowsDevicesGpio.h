...
#ifndef OBJCUWP_WINDOWS_DEVICES_GPIO_EXPORT
#define OBJCUWP_WINDOWS_DEVICES_GPIO_EXPORT __declspec(dllimport)
#ifndef IN_OBJCUWP_BUILD
#pragma comment(lib, "ObjCUWP_Windows_Devices_Gpio.lib")
#endif
#endif
