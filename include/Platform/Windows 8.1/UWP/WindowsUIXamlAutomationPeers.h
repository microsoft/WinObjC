...
WINRT_EXPORT
@interface WUXAPHubSectionAutomationPeer : WUXAPFrameworkElementAutomationPeer
@end
...
WINRT_EXPORT
@interface WUXAPAppBarAutomationPeer : WUXAPFrameworkElementAutomationPeer <WUXAPIExpandCollapseProvider, WUXAPIToggleProvider>
@property (readonly) WUXAExpandCollapseState expandCollapseState;
@property (readonly) WUXAToggleState toggleState;
- (void)collapse;
- (void)expand;
