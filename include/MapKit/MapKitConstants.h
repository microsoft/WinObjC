...
MAPKIT_EXPORT const MKMapRect MKMapRectNull;
MAPKIT_EXPORT const MKMapSize MKMapSizeWorld;
MAPKIT_EXPORT const MKMapRect MKMapRectWorld;
MAPKIT_EXPORT NSString* const MKErrorDomain;
