...
UIKIT_EXPORT NSString* const UIStateRestorationViewControllerStoryboardKey;
UIKIT_EXPORT NSString* const UIApplicationStateRestorationBundleVersionKey;
UIKIT_EXPORT NSString* const UIApplicationStateRestorationUserInterfaceIdiomKey;
