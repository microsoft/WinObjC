...
- (instancetype)initWithSearchController:(UISearchController*)searchController STUB_METHOD;
@property (readonly, nonatomic, strong) UISearchController* searchController STUB_PROPERTY;
@end
