...
class ExtraKerning : public WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Mask>>, public ::testing::WithParamInterface<CGFloat> {
    CFStringRef CreateOutputFilename() {
...
class LineHeightMultiple : public WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Mask>>, public ::testing::WithParamInterface<CGFloat> {
    CFStringRef CreateOutputFilename() {
...
class Fonts : public WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Mask>>, public ::testing::WithParamInterface<CFStringRef> {
    CFStringRef CreateOutputFilename() {
