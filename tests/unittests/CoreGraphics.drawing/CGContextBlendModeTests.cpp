...
class CGContextBlendMode : public WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>, public ::testing::WithParamInterface<::testing::tuple<CGFloat, CGNamedBlendMode>> {
