...
TEST(CoreFoundation, CFUUIDCreate) {
    ...
    ASSERT_TRUE_MSG(str1 != NULL, 
        "FAILED: [CFUUIDCreate] str1 should be non-null!");
...
TEST(CoreFoundation, CFUUIDGetConstant) {
    ...
    CFUUIDRef uuid4 =
        CFUUIDGetConstantUUIDWithBytes(NULL, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
    ...
    CFUUIDRef uuid5 =
        CFUUIDGetConstantUUIDWithBytes(NULL, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
    CFUUIDRef uuid6 =
        CFUUIDGetConstantUUIDWithBytes(NULL, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE);
