...
DISABLED_DRAW_TEST_F(CGPath, AddCurveToPoint, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
...
DISABLED_DRAW_TEST_F(CGPath, AddEllipse, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, AddLineToPoint, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, AddPath, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, AddQuadCurveToPoint, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, AddRect, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, Apply, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, CloseSubpath, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGPath, GetBoundingBox, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
