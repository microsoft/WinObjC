...
DISABLED_DRAW_TEST_F(CGContext, Shadow, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
...
DISABLED_DRAW_TEST_F(CGContext, ShadowWithRotatedCTM, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
