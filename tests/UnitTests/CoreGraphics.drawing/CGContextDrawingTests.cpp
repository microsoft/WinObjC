...
DRAW_TEST_F(CGContext, LinearGradientShortBothSides_Options_0, UIKitMimicTest) {
...
DRAW_TEST_F(CGContext, LinearGradientShortBothSides_Options_kCGGradientDrawsAfterEndLocation, UIKitMimicTest) {
...
DRAW_TEST_F(CGContext, LinearGradient2Short, UIKitMimicTest) {
    CGContextRef context = GetDrawingContext();
