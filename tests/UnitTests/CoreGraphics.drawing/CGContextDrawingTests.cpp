...
DISABLED_DRAW_TEST_F(CGContext, RedBox, UIKitMimicTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
...
DISABLED_DRAW_TEST_F(CGContext, FillThenStrokeIsSameAsDrawFillStroke, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGContext, OverlappingCirclesColorAlpha, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGContext, OverlappingCirclesGlobalAlpha, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGContext, OverlappingCirclesGlobalAlphaStackedWithColorAlpha, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGContext, OverlappingCirclesTransparencyLayerAlpha, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
...
DISABLED_DRAW_TEST_F(CGContext, ChangeCTMAfterCreatingPath, WhiteBackgroundTest<PixelByPixelImageComparator<ComparisonMode::Exact>>) {
    CGContextRef context = GetDrawingContext();
    CGRect bounds = GetDrawingBounds();
