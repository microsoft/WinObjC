...
, WMIIPhotoImportOperation, WMIIPhotoImportStorageMedium, WMIIPhotoImportSourceStatics, WMIIPhotoImportSource, WMIIPhotoImportSession,
    WMIIPhotoImportSession2, WMIIPhotoImportItem, WMIIPhotoImportFindItemsResult, WMIIPhotoImportFindItemsResult2,
    WMIIPhotoImportImportItemsResult, WMIIPhotoImportDeleteImportedItemsFromSourceResult, WMIIPhotoImportSidecar,
    WMIIPhotoImportVideoSegment, WMIIPhotoImportItemImportedEventArgs, WMIIPhotoImportSelectionChangedEventArgs;
