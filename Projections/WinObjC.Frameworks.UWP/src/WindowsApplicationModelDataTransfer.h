...
, WADIStandardDataFormatsStatics2, WADIDataPackagePropertySetView, WADIDataPackagePropertySetView2, WADIDataPackagePropertySetView3,
    ...
    WADIOperationCompletedEventArgs, WADIOperationCompletedEventArgs2, WADIDataPackageView, WADIDataPackageView2, WADIDataPackageView3,
    WADIDataPackageView4, WADIDataPackage, WADIDataPackage2, WADIHtmlFormatHelperStatics, WADIClipboardStatics, WADIDataRequestDeferral,
    WADIDataRequest, WADIDataRequestedEventArgs, WADITargetApplicationChosenEventArgs, WADIDataTransferManager,
    WADIDataTransferManagerStatics, WADIDataTransferManagerStatics2, WADISharedStorageAccessManagerStatics;
