...
@class WACChatMessageTransportConfiguration, WACChatMessage, WACChatMessageChange, WACChatMessageChangeReader, WACChatMessageAttachment,
    ...
    WACChatSyncManager, WACChatCapabilities, WACRemoteParticipantComposingChangedEventArgs, WACChatSyncConfiguration,
    WACRcsEndUserMessageManager, WACRcsTransport, WACRcsTransportConfiguration, WACRcsServiceKindSupportedChangedEventArgs,
    WACRcsEndUserMessageAvailableEventArgs, WACRcsEndUserMessageAction, WACRcsEndUserMessage, WACChatMessageManager,
...
, WACIChatMessageTransport2, WACIChatMessageTransportConfiguration, WACIChatMessageChange, WACIChatMessageChangeReader,
    WACIChatMessageChangeTracker, WACIChatMessageValidationResult, WACIChatMessage, WACIChatMessage3, WACIChatMessage2, WACIChatMessage4,
    WACIChatQueryOptions, WACIChatMessageStore, WACIChatMessageStore2, WACIChatMessageStore3, WACIChatMessageStoreChangedEventArgs,
    ...
    WACIChatMessageManager2Statics, WACIChatMessageManagerStatics3, WACIChatMessageReader, WACIChatMessageReader2, WACIChatSearchReader,
    WACIChatItem, WACIChatMessageAttachment, WACIChatMessageAttachment2, WACIChatMessageAttachmentFactory,
    WACIChatMessageNotificationTriggerDetails, WACIChatMessageNotificationTriggerDetails2, WACIChatCapabilities,
    WACIChatCapabilitiesManagerStatics, WACIChatRecipientDeliveryInfo, WACIChatConversationThreadingInfo, WACIChatConversationReader,
    WACIChatConversation, WACIChatConversation2, WACIRemoteParticipantComposingChangedEventArgs, WACIChatSyncManager,
    WACIChatSyncConfiguration, WACIRcsServiceKindSupportedChangedEventArgs, WACIRcsManagerStatics, WACIRcsTransport,
    WACIRcsTransportConfiguration, WACIRcsEndUserMessageManager, WACIRcsEndUserMessageAction, WACIRcsEndUserMessage,
    WACIRcsEndUserMessageAvailableEventArgs, WACIRcsEndUserMessageAvailableTriggerDetails;
