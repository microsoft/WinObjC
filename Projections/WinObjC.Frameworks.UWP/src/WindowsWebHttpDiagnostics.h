...
@class WWHDHttpDiagnosticSourceLocation, WWHDHttpDiagnosticProviderRequestSentEventArgs,
    WWHDHttpDiagnosticProviderResponseReceivedEventArgs, WWHDHttpDiagnosticProviderRequestResponseTimestamps,
    WWHDHttpDiagnosticProviderRequestResponseCompletedEventArgs, WWHDHttpDiagnosticProvider;
@protocol WWHDIHttpDiagnosticSourceLocation
, WWHDIHttpDiagnosticProviderRequestSentEventArgs, WWHDIHttpDiagnosticProviderResponseReceivedEventArgs,
    WWHDIHttpDiagnosticProviderRequestResponseTimestamps, WWHDIHttpDiagnosticProviderRequestResponseCompletedEventArgs,
    WWHDIHttpDiagnosticProviderStatics, WWHDIHttpDiagnosticProvider;
...
- (EventRegistrationToken)addRequestResponseCompletedEvent:(void (^)(WWHDHttpDiagnosticProvider*,
                                                                     WWHDHttpDiagnosticProviderRequestResponseCompletedEventArgs*))del;
...
- (EventRegistrationToken)addResponseReceivedEvent:(void (^)(WWHDHttpDiagnosticProvider*,
                                                             WWHDHttpDiagnosticProviderResponseReceivedEventArgs*))del;
