...
@protocol WPMDIEnterprise
, WPMDIEnterpriseEnrollmentManager, WPMDIPackageInstallResult, WPMDIPackageInstallResult2, WPMDIEnterpriseEnrollmentResult,
...
+ (void)addPackagePreloadedAsync:(NSString*)title
                  sourceLocation:(WFUri*)sourceLocation
                      instanceId:(NSString*)instanceId
                        ...
                        progress:(void (^)(unsigned int))progress
                         failure:(void (^)(NSError*))failure;
// Failed to generate member GetPendingPackageInstalls (Can't marshal
