...
@class WAAAppExtensionCatalog, WAAAppExtension, WAAAppExtensionPackageInstalledEventArgs, WAAAppExtensionPackageUpdatingEventArgs,
    WAAAppExtensionPackageUpdatedEventArgs, WAAAppExtensionPackageUninstallingEventArgs, WAAAppExtensionPackageStatusChangedEventArgs;
@protocol WAAIAppExtensionCatalogStatics
, WAAIAppExtensionCatalog, WAAIAppExtension, WAAIAppExtensionPackageInstalledEventArgs, WAAIAppExtensionPackageUpdatingEventArgs,
    WAAIAppExtensionPackageUpdatedEventArgs, WAAIAppExtensionPackageUninstallingEventArgs, WAAIAppExtensionPackageStatusChangedEventArgs;
...
- (EventRegistrationToken)addPackageStatusChangedEvent:(void (^)(WAAAppExtensionCatalog*,
                                                                 WAAAppExtensionPackageStatusChangedEventArgs*))del;
