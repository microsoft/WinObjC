...
@class WACDContactDataProviderConnection, WACDContactListSyncManagerSyncRequestEventArgs,
    WACDContactListServerSearchReadBatchRequestEventArgs, WACDContactDataProviderTriggerDetails, WACDContactListSyncManagerSyncRequest,
    WACDContactListServerSearchReadBatchRequest;
@protocol WACDIContactDataProviderTriggerDetails
, WACDIContactDataProviderConnection, WACDIContactListSyncManagerSyncRequest, WACDIContactListServerSearchReadBatchRequest,
    WACDIContactListSyncManagerSyncRequestEventArgs, WACDIContactListServerSearchReadBatchRequestEventArgs;
...
- (EventRegistrationToken)addServerSearchReadBatchRequestedEvent:(void (^)(WACDContactDataProviderConnection*,
                                                                           WACDContactListServerSearchReadBatchRequestEventArgs*))del;
...
- (EventRegistrationToken)addSyncRequestedEvent:(void (^)(WACDContactDataProviderConnection*,
                                                          WACDContactListSyncManagerSyncRequestEventArgs*))del;
