...
@class WDAAllJoynStatus, WDAAllJoynAboutData, WDAAllJoynBusAttachment, WDAAllJoynBusAttachmentStateChangedEventArgs,
    ...
    WDAAllJoynServiceInfo, WDAAllJoynAboutDataView, WDAAllJoynAcceptSessionJoinerEventArgs, WDAAllJoynSessionJoinedEventArgs,
    WDAAllJoynCredentials, WDAAllJoynSession, WDAAllJoynSessionMemberAddedEventArgs, WDAAllJoynSessionMemberRemovedEventArgs,
    ...
    WDAAllJoynWatcherStoppedEventArgs, WDAAllJoynServiceInfoRemovedEventArgs, WDAAllJoynMessageInfo;
@protocol WDAIAllJoynStatusStatics
, WDAIAllJoynBusAttachment, WDAIAllJoynBusAttachment2, WDAIAllJoynBusAttachmentStatics, WDAIAllJoynBusAttachmentStateChangedEventArgs,
    WDAIAllJoynCredentials, WDAIAllJoynCredentialsRequestedEventArgs, WDAIAllJoynCredentialsVerificationRequestedEventArgs,
    WDAIAllJoynAuthenticationCompleteEventArgs, WDAIAllJoynBusAttachmentFactory, WDAIAllJoynSession, WDAIAllJoynSessionStatics,
    WDAIAllJoynProducer, WDAIAllJoynBusObject, WDAIAllJoynBusObjectFactory, WDAIAllJoynServiceInfo, WDAIAllJoynServiceInfoStatics,
    WDAIAllJoynServiceInfoFactory, WDAIAllJoynAboutDataViewStatics, WDAIAllJoynAboutDataView, WDAIAllJoynAboutData,
    ...
    WDAIAllJoynSessionMemberRemovedEventArgsFactory, WDAIAllJoynSessionJoinedEventArgs, WDAIAllJoynSessionJoinedEventArgsFactory,
    WDAIAllJoynSessionLostEventArgs, WDAIAllJoynSessionLostEventArgsFactory, WDAIAllJoynProducerStoppedEventArgs,
    WDAIAllJoynProducerStoppedEventArgsFactory, WDAIAllJoynBusObjectStoppedEventArgs, WDAIAllJoynBusObjectStoppedEventArgsFactory,
    WDAIAllJoynWatcherStoppedEventArgs, WDAIAllJoynWatcherStoppedEventArgsFactory, WDAIAllJoynServiceInfoRemovedEventArgs,
    WDAIAllJoynServiceInfoRemovedEventArgsFactory, WDAIAllJoynMessageInfo, WDAIAllJoynMessageInfoFactory;
...
- (EventRegistrationToken)addAcceptSessionJoinerRequestedEvent:(void (^)(WDAAllJoynBusAttachment*,
                                                                         WDAAllJoynAcceptSessionJoinerEventArgs*))del;
