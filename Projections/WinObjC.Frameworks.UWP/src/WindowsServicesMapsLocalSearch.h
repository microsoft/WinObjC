...
@class WSMLLocalLocation, WSMLLocalLocationFinderResult, WSMLLocalLocationRatingInfo, WSMLLocalLocationHoursOfOperationItem,
    WSMLLocalLocationFinder, WSMLLocalCategories;
@protocol WSMLILocalLocation
, WSMLILocalLocationFinderResult, WSMLILocalLocationFinderStatics, WSMLILocalCategoriesStatics, WSMLILocalLocationHoursOfOperationItem,
    WSMLILocalLocationRatingInfo, WSMLILocalLocation2;
