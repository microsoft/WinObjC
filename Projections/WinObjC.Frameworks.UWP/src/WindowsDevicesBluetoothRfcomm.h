...
, WDBRIRfcommServiceId, WDBRIRfcommDeviceServicesResult, WDBRIRfcommDeviceServiceStatics, WDBRIRfcommDeviceServiceStatics2,
    WDBRIRfcommDeviceService, WDBRIRfcommDeviceService2, WDBRIRfcommDeviceService3, WDBRIRfcommServiceProviderStatics,
    WDBRIRfcommServiceProvider, WDBRIRfcommServiceProvider2;
