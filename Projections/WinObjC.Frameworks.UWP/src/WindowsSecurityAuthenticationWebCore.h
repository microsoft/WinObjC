...
@class WSAWCWebAccountEventArgs, WSAWCWebTokenRequest, WSAWCWebAccountMonitor, WSAWCWebAuthenticationCoreManager, WSAWCWebProviderError,
    WSAWCWebTokenResponse, WSAWCWebTokenRequestResult;
@protocol WSAWCIWebTokenRequest
, WSAWCIWebTokenRequest2, WSAWCIWebAccountEventArgs, WSAWCIWebTokenRequestFactory, WSAWCIWebAuthenticationCoreManagerStatics,
    WSAWCIWebAuthenticationCoreManagerStatics2, WSAWCIWebAuthenticationCoreManagerStatics3, WSAWCIWebAccountMonitor, WSAWCIWebProviderError,
    WSAWCIWebProviderErrorFactory, WSAWCIWebTokenRequestResult, WSAWCIWebTokenResponse, WSAWCIWebTokenResponseFactory;
