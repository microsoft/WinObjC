...
#ifndef __ITypedEventHandler_Windows_UI_Xaml_Documents_Hyperlink_Windows_UI_Xaml_Documents_HyperlinkClickEventArgs__DEFINED
#define __ITypedEventHandler_Windows_UI_Xaml_Documents_Hyperlink_Windows_UI_Xaml_Documents_HyperlinkClickEventArgs__DEFINED
class ITypedEventHandler_Windows_UI_Xaml_Documents_Hyperlink_Windows_UI_Xaml_Documents_HyperlinkClickEventArgs
    : public RuntimeClass<RuntimeClassFlags<WinRtClassicComMix>,
                          ABI::Windows::Foundation::ITypedEventHandler<ABI::Windows::UI::Xaml::Documents::Hyperlink*,
                                                                       ABI::Windows::UI::Xaml::Documents::HyperlinkClickEventArgs*>> {
    void (^_delegate)(WUXDHyperlink*, WUXDHyperlinkClickEventArgs*);

public:
    ITypedEventHandler_Windows_UI_Xaml_Documents_Hyperlink_Windows_UI_Xaml_Documents_HyperlinkClickEventArgs(
        void (^del)(WUXDHyperlink*, WUXDHyperlinkClickEventArgs*))
        : _delegate([del copy]) {
    }
    ~ITypedEventHandler_Windows_UI_Xaml_Documents_Hyperlink_Windows_UI_Xaml_Documents_HyperlinkClickEventArgs() {
        [_delegate release];
    ...
    virtual HRESULT STDMETHODCALLTYPE Invoke(ABI::Windows::UI::Xaml::Documents::IHyperlink* arg0,
                                             ABI::Windows::UI::Xaml::Documents::IHyperlinkClickEventArgs* arg1) override {
        @autoreleasepool {
            _delegate(_createRtProxy<WUXDHyperlink>(arg0), _createRtProxy<WUXDHyperlinkClickEventArgs>(arg1));
            return 0;
        };
    }
};
...
class WUXDITextElementOverrides_RtProxy : public RuntimeClass<ABI::Windows::UI::Xaml::Documents::ITextElementOverrides, ComposableBase<>> {
    InspectableClass(L"WUXDITextElementOverrides_RtProxy", TrustLevel::BaseTrust) public : RTObject<WUXDITextElementOverrides>* _inner;
