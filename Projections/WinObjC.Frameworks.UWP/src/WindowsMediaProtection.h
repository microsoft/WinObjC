...
@class WMPMediaProtectionManager, WMPServiceRequestedEventArgs, WMPComponentLoadFailedEventArgs, WMPMediaProtectionServiceCompletion,
    WMPRevocationAndRenewalInformation, WMPRevocationAndRenewalItem, WMPMediaProtectionPMPServer, WMPProtectionCapabilities, WMPHdcpSession,
    WMPComponentRenewal;
...
, WMPIMediaProtectionServiceCompletion, WMPIServiceRequestedEventArgs, WMPIMediaProtectionServiceRequest, WMPIServiceRequestedEventArgs2,
    ...
    WMPIMediaProtectionPMPServerFactory, WMPIMediaProtectionPMPServer, WMPIProtectionCapabilities, WMPIHdcpSession,
    WMPIComponentRenewalStatics;
