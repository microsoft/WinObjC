...
@class WSSStoreProduct, WSSStoreProductPagedQueryResult, WSSStorePurchaseProperties, WSSStoreLicense, WSSStoreImage, WSSStoreVideo,
    WSSStoreSku, WSSStorePrice, WSSStorePurchaseResult, WSSStoreAvailability, WSSStoreCollectionData, WSSStoreSubscriptionInfo,
    WSSStoreContext, WSSStoreSendRequestResult, WSSStoreAppLicense, WSSStoreProductResult, WSSStoreProductQueryResult,
    WSSStoreConsumableResult, WSSStoreAcquireLicenseResult, WSSStorePackageUpdate, WSSStorePackageUpdateResult, WSSStorePackageLicense,
    WSSStoreRequestHelper;
@class WSSStorePackageUpdateStatus;
@protocol WSSIStoreProductPagedQueryResult
, WSSIStoreProductQueryResult, WSSIStoreProductResult, WSSIStorePurchaseProperties, WSSIStorePurchasePropertiesFactory,
    WSSIStoreCollectionData, WSSIStoreLicense, WSSIStoreAppLicense, WSSIStoreSendRequestResult, WSSIStoreProduct, WSSIStoreImage,
    WSSIStoreVideo, WSSIStoreSku, WSSIStoreAvailability, WSSIStorePrice, WSSIStoreSubscriptionInfo, WSSIStoreConsumableResult,
    WSSIStorePurchaseResult, WSSIStoreContextStatics, WSSIStoreRequestHelperStatics, WSSIStoreContext, WSSIStorePackageUpdate,
    WSSIStorePackageUpdateResult, WSSIStoreAcquireLicenseResult, WSSIStorePackageLicense;
