...
@protocol WAPNINotePlacementChangedPreviewEventArgs
, WAPNINoteVisibilityChangedPreviewEventArgs, WAPNINotesWindowManagerPreview, WAPNINotesWindowManagerPreviewStatics;
...
- (EventRegistrationToken)addNotePlacementChangedEvent:(void (^)(WAPNNotesWindowManagerPreview*,
                                                                 WAPNNotePlacementChangedPreviewEventArgs*))del;
...
- (EventRegistrationToken)addNoteVisibilityChangedEvent:(void (^)(WAPNNotesWindowManagerPreview*,
                                                                  WAPNNoteVisibilityChangedPreviewEventArgs*))del;
