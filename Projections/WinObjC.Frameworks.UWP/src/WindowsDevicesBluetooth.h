...
@class WDBBluetoothDevice, WDBBluetoothClassOfDevice, WDBBluetoothLEAppearanceCategories, WDBBluetoothLEAppearanceSubcategories,
    WDBBluetoothLEAppearance, WDBBluetoothLEDevice, WDBBluetoothSignalStrengthFilter;
@protocol WDBIBluetoothDeviceStatics
, WDBIBluetoothDeviceStatics2, WDBIBluetoothDevice, WDBIBluetoothDevice2, WDBIBluetoothDevice3, WDBIBluetoothLEAppearanceCategoriesStatics,
    WDBIBluetoothLEAppearanceSubcategoriesStatics, WDBIBluetoothLEAppearance, WDBIBluetoothLEAppearanceStatics, WDBIBluetoothLEDevice,
    WDBIBluetoothLEDevice2, WDBIBluetoothLEDeviceStatics, WDBIBluetoothLEDeviceStatics2, WDBIBluetoothClassOfDevice,
