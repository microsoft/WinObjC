...
@class WMAAudioGraph, WMACreateAudioGraphResult, WMAAudioGraphSettings, WMAAudioDeviceInputNode, WMACreateAudioDeviceInputNodeResult,
    ...
    WMAAudioFileOutputNode, WMACreateAudioFileOutputNodeResult, WMAAudioGraphUnrecoverableErrorOccurredEventArgs, WMAAudioGraphBatchUpdater,
    WMAAudioFrameInputNode, WMAAudioFrameOutputNode, WMAAudioSubmixNode, WMAAudioNodeEmitter, WMAAudioNodeListener, WMAAudioGraphConnection,
    WMAAudioFrameCompletedEventArgs, WMAFrameInputNodeQuantumStartedEventArgs, WMAEqualizerBand, WMAEqualizerEffectDefinition,
    WMAReverbEffectDefinition, WMAEchoEffectDefinition, WMALimiterEffectDefinition, WMAAudioNodeEmitterConeProperties,
    WMAAudioNodeEmitterShape, WMAAudioNodeEmitterNaturalDecayModelProperties, WMAAudioNodeEmitterDecayModel;
...
, WMAIAudioGraphSettingsFactory, WMAIAudioGraphSettings, WMAIAudioGraphStatics, WMAICreateAudioDeviceInputNodeResult,
    ...
    WMAIAudioGraphUnrecoverableErrorOccurredEventArgs, WMAIAudioGraph, WMAIAudioGraph2, WMAIAudioNode, WMAIAudioNodeWithListener,
    WMAIAudioInputNode, WMAIAudioInputNode2, WMAIAudioFrameInputNode, WMAIAudioFileInputNode, WMAIAudioDeviceInputNode,
    WMAIAudioDeviceOutputNode, WMAIAudioFrameOutputNode, WMAIAudioFileOutputNode, WMAIAudioFrameCompletedEventArgs,
    WMAIFrameInputNodeQuantumStartedEventArgs, WMAIAudioGraphConnection, WMAIEqualizerBand, WMAIEqualizerEffectDefinitionFactory,
    WMAIReverbEffectDefinitionFactory, WMAIEchoEffectDefinitionFactory, WMAILimiterEffectDefinitionFactory,
    WMAIAudioNodeEmitterConeProperties, WMAIAudioNodeEmitterShape, WMAIAudioNodeEmitterShapeStatics,
    WMAIAudioNodeEmitterNaturalDecayModelProperties, WMAIAudioNodeEmitterDecayModel, WMAIAudioNodeEmitterDecayModelStatics,
    WMAIAudioNodeEmitter, WMAIAudioNodeEmitter2, WMAIAudioNodeEmitterFactory, WMAIAudioNodeListener, WMAIEqualizerEffectDefinition,
    WMAIReverbEffectDefinition, WMAIEchoEffectDefinition, WMAILimiterEffectDefinition;
...
+ (WMAAudioNodeEmitter*)makeAudioNodeEmitter:(WMAAudioNodeEmitterShape*)shape
                                  decayModel:(WMAAudioNodeEmitterDecayModel*)decayModel
                                    settings:(WMAAudioNodeEmitterSettings)settings ACTIVATOR;
