...
@class WSAIPSecondaryAuthenticationFactorRegistration, WSAIPSecondaryAuthenticationFactorRegistrationResult,
    WSAIPSecondaryAuthenticationFactorAuthentication, WSAIPSecondaryAuthenticationFactorAuthenticationResult,
...
, WSAIPISecondaryAuthenticationFactorAuthenticationResult, WSAIPISecondaryAuthenticationFactorRegistrationStatics,
    WSAIPISecondaryAuthenticationFactorRegistration, WSAIPISecondaryAuthenticationFactorAuthenticationStatics,
    WSAIPISecondaryAuthenticationFactorAuthentication, WSAIPISecondaryAuthenticationFactorInfo,
    WSAIPISecondaryAuthenticationFactorAuthenticationStageInfo, WSAIPISecondaryAuthenticationFactorAuthenticationStageChangedEventArgs;
...
+ (EventRegistrationToken)addAuthenticationStageChangedEvent:
    (void (^)(RTObject*, WSAIPSecondaryAuthenticationFactorAuthenticationStageChangedEventArgs*))del;
