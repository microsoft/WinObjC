...
@class WDTSemanticTextQuery, WDTUnicodeCharacters, WDTAlternateWordForm, WDTWordSegment, WDTWordsSegmenter, WDTSelectableWordSegment,
    WDTSelectableWordsSegmenter, WDTTextPredictionGenerator, WDTTextConversionGenerator, WDTTextReverseConversionGenerator, WDTTextPhoneme;
...
, WDTISemanticTextQuery, WDTIUnicodeCharactersStatics, WDTIAlternateWordForm, WDTISelectableWordSegment, WDTIWordSegment,
    ...
    WDTITextReverseConversionGenerator, WDTITextReverseConversionGeneratorFactory, WDTITextPhoneme, WDTITextReverseConversionGenerator2;
