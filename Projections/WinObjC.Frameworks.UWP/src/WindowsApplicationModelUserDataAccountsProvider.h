...
@class WAUPUserDataAccountPartnerAccountInfo, WAUPUserDataAccountProviderAddAccountOperation, WAUPUserDataAccountProviderSettingsOperation,
    WAUPUserDataAccountProviderResolveErrorsOperation;
@protocol WAUPIUserDataAccountProviderOperation
, WAUPIUserDataAccountProviderAddAccountOperation, WAUPIUserDataAccountPartnerAccountInfo, WAUPIUserDataAccountProviderSettingsOperation,
    WAUPIUserDataAccountProviderResolveErrorsOperation;
