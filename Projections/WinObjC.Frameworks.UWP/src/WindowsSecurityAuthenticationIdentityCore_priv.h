...
// WindowsSecurityAuthenticationIdentityCore_priv.h
...
@class RTProxiedIterableNSArray_NSString, RTProxiedNSArray_NSString, RTProxiedNSArray_WSAICMicrosoftAccountMultiFactorSessionInfo;
