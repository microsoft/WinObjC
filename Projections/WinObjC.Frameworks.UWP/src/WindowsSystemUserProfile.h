...
@class WSUAdvertisingManagerForUser, WSUAdvertisingManager, WSUUserProfilePersonalizationSettings, WSUGlobalizationPreferences,
    WSUFirstSignInSettings, WSUUserInformation, WSULockScreen;
@protocol WSUIAdvertisingManagerStatics
, WSUIAdvertisingManagerForUser, WSUIAdvertisingManagerStatics2, WSUIUserProfilePersonalizationSettings,
    WSUIUserProfilePersonalizationSettingsStatics, WSUIGlobalizationPreferencesStatics, WSUIFirstSignInSettings,
    WSUIFirstSignInSettingsStatics, WSUIUserInformationStatics, WSUILockScreenStatics, WSUILockScreenImageFeedStatics;
