...
, WWHFIHttpCacheControl, WWHFIHttpServerCustomValidationRequestedEventArgs, WWHFIHttpBaseProtocolFilter, WWHFIHttpBaseProtocolFilter2,
    WWHFIHttpBaseProtocolFilter3, WWHFIHttpBaseProtocolFilter4;
...
- (EventRegistrationToken)addServerCustomValidationRequestedEvent:(void (^)(WWHFHttpBaseProtocolFilter*,
                                                                            WWHFHttpServerCustomValidationRequestedEventArgs*))del;
