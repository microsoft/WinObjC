...
, WSICurrentAppWithConsumables, WSICurrentAppWithCampaignId, WSICurrentApp2Statics, WSICurrentAppSimulator,
    WSICurrentAppSimulatorWithCampaignId, WSICurrentAppSimulatorWithConsumables, WSIPurchaseResults, WSILicenseInformation,
    WSIProductLicense, WSIListingInformation, WSIListingInformation2, WSIProductListing, WSIProductListingWithConsumables,
    WSIProductListing2, WSICurrentAppStaticsWithFiltering, WSICurrentAppSimulatorStaticsWithFiltering, WSIProductLicenseWithFulfillment,
    WSIProductListingWithMetadata, WSIUnfulfilledConsumable, WSIProductPurchaseDisplayProperties,
    WSIProductPurchaseDisplayPropertiesFactory;
