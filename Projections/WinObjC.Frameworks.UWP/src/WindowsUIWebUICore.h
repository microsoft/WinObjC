...
@class WUWCWebUICommandBarItemInvokedEventArgs, WUWCWebUICommandBarIconButton, WUWCWebUICommandBarConfirmationButton,
    WUWCWebUICommandBarBitmapIcon, WUWCWebUICommandBarSymbolIcon, WUWCWebUICommandBarSizeChangedEventArgs, WUWCWebUICommandBar;
@protocol WUWCIWebUICommandBarItemInvokedEventArgs
, WUWCIWebUICommandBarElement, WUWCIWebUICommandBarIcon, WUWCIWebUICommandBarIconButton, WUWCIWebUICommandBarConfirmationButton,
    WUWCIWebUICommandBarBitmapIcon, WUWCIWebUICommandBarBitmapIconFactory, WUWCIWebUICommandBarSymbolIcon,
...
- (EventRegistrationToken)addItemInvokedEvent:(void (^)(WUWCWebUICommandBarConfirmationButton*,
                                                        WUWCWebUICommandBarItemInvokedEventArgs*))del;
- (void)removeItemInvokedEvent:(EventRegistrationToken)tok;
@end
