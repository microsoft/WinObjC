...
@class WGCalendarIdentifiers, WGClockIdentifiers, WGNumeralSystemIdentifiers, WGCurrencyIdentifiers, WGGeographicRegion, WGLanguage,
    WGCalendar, WGApplicationLanguages, WGJapanesePhoneme, WGJapanesePhoneticAnalyzer;
@protocol WGICalendarIdentifiersStatics
, WGICalendarIdentifiersStatics2, WGICalendarIdentifiersStatics3, WGIClockIdentifiersStatics, WGINumeralSystemIdentifiersStatics,
    WGINumeralSystemIdentifiersStatics2, WGICurrencyIdentifiersStatics, WGIGeographicRegion, WGIGeographicRegionFactory,
    WGIGeographicRegionStatics, WGILanguage, WGILanguageExtensionSubtags, WGILanguageFactory, WGILanguageStatics, WGILanguageStatics2,
    WGICalendar, WGICalendarFactory2, WGITimeZoneOnCalendar, WGICalendarFactory, WGIApplicationLanguagesStatics,
    WGIJapanesePhoneticAnalyzerStatics, WGIJapanesePhoneme;
