...
#ifndef OBJCUWPWINDOWSGRAPHICSPRINTINGEXPORT
#define OBJCUWPWINDOWSGRAPHICSPRINTINGEXPORT __declspec(dllimport)
#ifndef IN_WinObjC_Frameworks_UWP_BUILD
#pragma comment(lib, "ObjCUWPWindowsGraphicsPrinting.lib")
#endif
#endif
#include <UWP/interopBase.h>

@class WGPPrintPageInfo, WGPPrintTaskOptions, WGPStandardPrintTaskOptions, WGPPrintTaskProgressingEventArgs, WGPPrintTaskCompletedEventArgs,
    WGPPrintTask, WGPPrintTaskSourceRequestedDeferral, WGPPrintTaskSourceRequestedArgs, WGPPrintTaskRequestedDeferral, WGPPrintTaskRequest,
    WGPPrintTaskRequestedEventArgs, WGPPrintManager;
@class WGPPrintPageDescription;
@protocol WGPIPrintTaskOptionsCoreProperties
, WGPIPrintPageInfo, WGPIPrintTaskOptions, WGPIPrintTaskOptionsCoreUIConfiguration, WGPIPrintTaskOptionsCore,
    WGPIStandardPrintTaskOptionsStatic, WGPIStandardPrintTaskOptionsStatic2, WGPIPrintDocumentSource, WGPIPrintTaskProgressingEventArgs,
    WGPIPrintTaskCompletedEventArgs, WGPIPrintTask, WGPIPrintTaskTargetDeviceSupport, WGPIPrintTask2, WGPIPrintTaskSourceRequestedDeferral,
    WGPIPrintTaskSourceRequestedArgs, WGPIPrintTaskRequestedDeferral, WGPIPrintTaskRequest, WGPIPrintTaskRequestedEventArgs,
    WGPIPrintManagerStatic, WGPIPrintManagerStatic2, WGPIPrintManager;
