...
@class WNSSocketActivityContext, WNSDatagramSocket, WNSStreamSocket, WNSStreamSocketListener, WNSSocketActivityInformation,
    ...
    WNSMessageWebSocketInformation, WNSMessageWebSocket, WNSMessageWebSocketMessageReceivedEventArgs,
    WNSWebSocketServerCustomValidationRequestedEventArgs, WNSStreamWebSocketControl, WNSStreamWebSocketInformation, WNSStreamWebSocket,
    WNSWebSocketKeepAlive, WNSSocketError, WNSWebSocketError, WNSSocketActivityTriggerDetails, WNSControlChannelTrigger;
...
, WNSISocketActivityTriggerDetails, WNSISocketActivityInformationStatics, WNSISocketActivityContext, WNSISocketActivityContextFactory,
    ...
    WNSIStreamSocket2, WNSIStreamSocket3, WNSIStreamSocketStatics, WNSIStreamSocketListenerControl, WNSIStreamSocketListenerControl2,
    WNSIStreamSocketListenerInformation, WNSIStreamSocketListenerConnectionReceivedEventArgs, WNSIStreamSocketListener,
    WNSIStreamSocketListener2, WNSIStreamSocketListener3, WNSIWebSocketServerCustomValidationRequestedEventArgs, WNSIWebSocketControl,
    WNSIWebSocketControl2, WNSIWebSocketInformation, WNSIWebSocketInformation2, WNSIWebSocket, WNSIMessageWebSocketControl,
    WNSIMessageWebSocket, WNSIMessageWebSocket2, WNSIStreamWebSocketControl, WNSIStreamWebSocket, WNSIStreamWebSocket2,
    WNSISocketErrorStatics, WNSIWebSocketErrorStatics, WNSIControlChannelTrigger, WNSIControlChannelTriggerFactory,
    WNSIControlChannelTriggerEventDetails, WNSIControlChannelTriggerResetEventDetails, WNSIControlChannelTrigger2;
...
- (EventRegistrationToken)addClosedEvent:(void (^)(RTObject<WNSIWebSocket>*, WNSWebSocketClosedEventArgs*))del;
- (void)removeClosedEvent:(EventRegistrationToken)tok;
- (EventRegistrationToken)addServerCustomValidationRequestedEvent:(void (^)(WNSMessageWebSocket*,
                                                                            WNSWebSocketServerCustomValidationRequestedEventArgs*))del;
...
- (EventRegistrationToken)addClosedEvent:(void (^)(RTObject<WNSIWebSocket>*, WNSWebSocketClosedEventArgs*))del;
- (void)removeClosedEvent:(EventRegistrationToken)tok;
- (EventRegistrationToken)addServerCustomValidationRequestedEvent:(void (^)(WNSStreamWebSocket*,
                                                                            WNSWebSocketServerCustomValidationRequestedEventArgs*))del;
- (void)removeServerCustomValidationRequestedEvent:(EventRegistrationToken)tok;
- (RTObject<WFIAsyncAction>*)connectAsync:(WFUri*)uri;
- (void)setRequestHeader:(NSString*)headerName headerValue:(NSString*)headerValue;
...
+ (WNSControlChannelTrigger*)makeControlChannelTrigger:(NSString*)channelId
                      serverKeepAliveIntervalInMinutes:(unsigned int)serverKeepAliveIntervalInMinutes ACTIVATOR;
