...
@class WSEFileProtectionInfo, WSEProtectedContainerExportResult, WSEProtectedContainerImportResult, WSEProtectedFileCreateResult,
    WSEBufferProtectUnprotectResult, WSEDataProtectionInfo, WSEProtectionPolicyAuditInfo, WSEThreadNetworkContext,
    WSEProtectionPolicyManager, WSEProtectedAccessSuspendingEventArgs, WSEProtectedAccessResumedEventArgs,
    WSEProtectedContentRevokedEventArgs, WSEFileRevocationManager, WSEFileProtectionManager, WSEDataProtectionManager;
@protocol WSEIFileRevocationManagerStatics
, WSEIFileProtectionManagerStatics, WSEIFileProtectionManagerStatics2, WSEIProtectedFileCreateResult, WSEIFileProtectionInfo,
    WSEIProtectedContainerExportResult, WSEIProtectedContainerImportResult, WSEIDataProtectionManagerStatics, WSEIDataProtectionInfo,
    WSEIBufferProtectUnprotectResult, WSEIProtectionPolicyAuditInfoFactory, WSEIProtectionPolicyAuditInfo, WSEIProtectionPolicyManager,
    WSEIProtectionPolicyManager2, WSEIProtectionPolicyManagerStatics, WSEIProtectionPolicyManagerStatics2,
    WSEIProtectionPolicyManagerStatics3, WSEIThreadNetworkContext, WSEIProtectedAccessSuspendingEventArgs,
    WSEIProtectedAccessResumedEventArgs, WSEIProtectedContentRevokedEventArgs;
...
+ (WSEProtectionPolicyAuditInfo*)make:(WSEProtectionPolicyAuditAction)action
                    ...
                    targetDescription:(NSString*)targetDescription ACTIVATOR;
+ (WSEProtectionPolicyAuditInfo*)makeWithActionAndDataDescription:(WSEProtectionPolicyAuditAction)action
                                                  dataDescription:(NSString*)dataDescription ACTIVATOR;
#if defined(__cplusplus)
+ (instancetype)createWith:(IInspectable*)obj __attribute__((ns_returns_autoreleased));
#endif
