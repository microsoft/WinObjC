...
@class WPPContactAddress, WPPContactInformation, WPPContactStore, WPPStoredContact, WPPKnownContactProperties, WPPContactQueryOptions,
    WPPContactQueryResult, WPPContactChangeRecord;
@protocol WPPIContactAddress
, WPPIContactInformation, WPPIContactInformation2, WPPIContactInformationStatics, WPPIStoredContact, WPPIStoredContactFactory,
    WPPIKnownContactPropertiesStatics, WPPIContactQueryResult, WPPIContactQueryOptions, WPPIContactStore, WPPIContactStore2,
    WPPIContactStoreStatics, WPPIContactChangeRecord;
