...
@class WSMGGuidanceRoadSignpost, WSMGGuidanceManeuver, WSMGGuidanceRoute, WSMGGuidanceMapMatchedCoordinate, WSMGGuidanceLaneInfo,
    WSMGGuidanceUpdatedEventArgs, WSMGGuidanceReroutedEventArgs, WSMGGuidanceAudioNotificationRequestedEventArgs, WSMGGuidanceNavigator,
    WSMGGuidanceRoadSegment, WSMGGuidanceTelemetryCollector;
@protocol WSMGIGuidanceRoadSignpost
, WSMGIGuidanceManeuver, WSMGIGuidanceUpdatedEventArgs, WSMGIGuidanceReroutedEventArgs, WSMGIGuidanceAudioNotificationRequestedEventArgs,
    WSMGIGuidanceNavigator, WSMGIGuidanceNavigator2, WSMGIGuidanceNavigatorStatics, WSMGIGuidanceNavigatorStatics2,
    WSMGIGuidanceRoadSegment, WSMGIGuidanceMapMatchedCoordinate, WSMGIGuidanceTelemetryCollectorStatics, WSMGIGuidanceTelemetryCollector,
    WSMGIGuidanceRouteStatics, WSMGIGuidanceRoute, WSMGIGuidanceLaneInfo;
...
- (EventRegistrationToken)addAudioNotificationRequestedEvent:(void (^)(WSMGGuidanceNavigator*,
                                                                       WSMGGuidanceAudioNotificationRequestedEventArgs*))del;
