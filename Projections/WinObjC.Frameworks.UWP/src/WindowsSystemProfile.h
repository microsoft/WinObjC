...
@class WSPAnalyticsVersionInfo, WSPAnalyticsInfo, WSPSystemIdentificationInfo, WSPSystemIdentification,
    WSPPlatformDiagnosticsAndUsageDataSettings, WSPHardwareToken, WSPHardwareIdentification, WSPRetailInfo, WSPKnownRetailInfoProperties,
    WSPSharedModeSettings;
@protocol WSPIAnalyticsInfoStatics
, WSPIAnalyticsVersionInfo, WSPISystemIdentificationInfo, WSPISystemIdentificationStatics,
    WSPIPlatformDiagnosticsAndUsageDataSettingsStatics, WSPIHardwareToken, WSPIHardwareIdentificationStatics, WSPIRetailInfoStatics,
    WSPIKnownRetailInfoPropertiesStatics, WSPISharedModeSettingsStatics;
