...
@class WACBPhoneCallBlockedTriggerDetails, WACBPhoneCallOriginDataRequestTriggerDetails, WACBPhoneNewVoicemailMessageTriggerDetails,
    WACBPhoneLineChangedTriggerDetails;
@protocol WACBIPhoneCallBlockedTriggerDetails
, WACBIPhoneCallOriginDataRequestTriggerDetails, WACBIPhoneNewVoicemailMessageTriggerDetails, WACBIPhoneLineChangedTriggerDetails;
