...
@class WAADAppointmentDataProviderConnection, WAADAppointmentCalendarSyncManagerSyncRequestEventArgs,
    WAADAppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs, WAADAppointmentCalendarCancelMeetingRequestEventArgs,
    WAADAppointmentCalendarForwardMeetingRequestEventArgs, WAADAppointmentCalendarProposeNewTimeForMeetingRequestEventArgs,
    WAADAppointmentCalendarUpdateMeetingResponseRequestEventArgs, WAADAppointmentDataProviderTriggerDetails,
    WAADAppointmentCalendarSyncManagerSyncRequest, WAADAppointmentCalendarCreateOrUpdateAppointmentRequest,
    WAADAppointmentCalendarCancelMeetingRequest, WAADAppointmentCalendarForwardMeetingRequest,
    WAADAppointmentCalendarProposeNewTimeForMeetingRequest, WAADAppointmentCalendarUpdateMeetingResponseRequest;
@protocol WAADIAppointmentDataProviderTriggerDetails
, WAADIAppointmentDataProviderConnection, WAADIAppointmentCalendarSyncManagerSyncRequest,
    WAADIAppointmentCalendarCreateOrUpdateAppointmentRequest, WAADIAppointmentCalendarCancelMeetingRequest,
    WAADIAppointmentCalendarForwardMeetingRequest, WAADIAppointmentCalendarProposeNewTimeForMeetingRequest,
    WAADIAppointmentCalendarUpdateMeetingResponseRequest, WAADIAppointmentCalendarSyncManagerSyncRequestEventArgs,
    WAADIAppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs, WAADIAppointmentCalendarCancelMeetingRequestEventArgs,
    WAADIAppointmentCalendarForwardMeetingRequestEventArgs, WAADIAppointmentCalendarProposeNewTimeForMeetingRequestEventArgs,
    WAADIAppointmentCalendarUpdateMeetingResponseRequestEventArgs;
...
- (EventRegistrationToken)addCancelMeetingRequestedEvent:(void (^)(WAADAppointmentDataProviderConnection*,
                                                                   WAADAppointmentCalendarCancelMeetingRequestEventArgs*))del;
...
- (EventRegistrationToken)addCreateOrUpdateAppointmentRequestedEvent:
    (void (^)(WAADAppointmentDataProviderConnection*, WAADAppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs*))del;
...
- (EventRegistrationToken)addForwardMeetingRequestedEvent:(void (^)(WAADAppointmentDataProviderConnection*,
                                                                    WAADAppointmentCalendarForwardMeetingRequestEventArgs*))del;
...
- (EventRegistrationToken)addProposeNewTimeForMeetingRequestedEvent:
    (void (^)(WAADAppointmentDataProviderConnection*, WAADAppointmentCalendarProposeNewTimeForMeetingRequestEventArgs*))del;
...
- (EventRegistrationToken)addSyncRequestedEvent:(void (^)(WAADAppointmentDataProviderConnection*,
                                                          WAADAppointmentCalendarSyncManagerSyncRequestEventArgs*))del;
- (void)removeSyncRequestedEvent:(EventRegistrationToken)tok;
- (EventRegistrationToken)addUpdateMeetingResponseRequestedEvent:
    (void (^)(WAADAppointmentDataProviderConnection*, WAADAppointmentCalendarUpdateMeetingResponseRequestEventArgs*))del;
