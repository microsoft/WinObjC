...
@class WDEDeviceConnectionChangeTriggerDetails, WDEDevicePickerAppearance, WDEDeviceSelectedEventArgs,
    WDEDeviceDisconnectButtonClickedEventArgs, WDEDevicePickerFilter, WDEDevicePicker, WDEDeviceThumbnail, WDEEnclosureLocation,
    WDEDeviceInformationUpdate, WDEDeviceInformationCollection, WDEDeviceWatcher, WDEDeviceInformation, WDEDevicePairingResult,
    WDEDeviceUnpairingResult, WDEDevicePairingRequestedEventArgs, WDEDeviceInformationCustomPairing, WDEDeviceInformationPairing,
    WDEDeviceAccessChangedEventArgs, WDEDeviceAccessInformation, WDEDeviceWatcherEvent, WDEDeviceWatcherTriggerDetails;
@protocol WDEIDeviceConnectionChangeTriggerDetails
, WDEIDevicePickerAppearance, WDEIDeviceSelectedEventArgs, WDEIDeviceDisconnectButtonClickedEventArgs, WDEIDevicePickerFilter,
    WDEIDevicePicker, WDEIEnclosureLocation, WDEIEnclosureLocation2, WDEIDeviceInformationUpdate, WDEIDeviceInformationUpdate2,
    WDEIDeviceWatcher, WDEIDeviceWatcher2, WDEIDeviceInformationStatics, WDEIDeviceInformationStatics2, WDEIDeviceInformation,
    WDEIDevicePairingResult, WDEIDeviceUnpairingResult, WDEIDevicePairingSettings, WDEIDevicePairingRequestedEventArgs,
    WDEIDeviceInformationCustomPairing, WDEIDeviceInformationPairing, WDEIDeviceInformationPairing2, WDEIDeviceInformationPairingStatics,
    WDEIDeviceInformation2, WDEIDeviceAccessChangedEventArgs, WDEIDeviceAccessChangedEventArgs2, WDEIDeviceAccessInformation,
    WDEIDeviceAccessInformationStatics, WDEIDeviceWatcherEvent, WDEIDeviceWatcherTriggerDetails;
