...
@class WPNMTextResponse, WPNMAppNotificationInfo, WPNMEmailAccountInfo, WPNMEmailFolderInfo, WPNMBinaryId,
    WPNMAlarmNotificationTriggerDetails, WPNMEmailReadNotificationTriggerDetails, WPNMEmailNotificationTriggerDetails, WPNMPhoneLineDetails,
    WPNMPhoneCallDetails, WPNMPhoneNotificationTriggerDetails, WPNMSpeedDialEntry, WPNMReminderNotificationTriggerDetails,
    WPNMCalendarChangedNotificationTriggerDetails, WPNMToastNotificationTriggerDetails, WPNMCortanaTileNotificationTriggerDetails,
    WPNMMediaMetadata, WPNMMediaControlsTriggerDetails, WPNMVolumeInfo, WPNMAccessoryManager;
@protocol WPNMITextResponse
, WPNMIAppNotificationInfo, WPNMIEmailAccountInfo, WPNMIEmailFolderInfo, WPNMIBinaryId, WPNMIAccessoryNotificationTriggerDetails,
    WPNMIAlarmNotificationTriggerDetails, WPNMIAlarmNotificationTriggerDetails2, WPNMIEmailNotificationTriggerDetails,
    WPNMIEmailNotificationTriggerDetails2, WPNMIEmailReadNotificationTriggerDetails, WPNMIPhoneLineDetails, WPNMIPhoneLineDetails2,
    WPNMIPhoneCallDetails, WPNMIPhoneNotificationTriggerDetails, WPNMISpeedDialEntry, WPNMIReminderNotificationTriggerDetails,
    WPNMIReminderNotificationTriggerDetails2, WPNMICalendarChangedNotificationTriggerDetails, WPNMIToastNotificationTriggerDetails,
    WPNMIToastNotificationTriggerDetails2, WPNMICortanaTileNotificationTriggerDetails, WPNMIMediaMetadata, WPNMIMediaControlsTriggerDetails,
    WPNMIVolumeInfo, WPNMIAccessoryManager, WPNMIAccessoryManager2, WPNMIAccessoryManager3;
