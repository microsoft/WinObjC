...
@class WSAICMicrosoftAccountMultiFactorSessionInfo, WSAICMicrosoftAccountMultiFactorOneTimeCodedInfo,
    WSAICMicrosoftAccountMultiFactorGetSessionsResult, WSAICMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo,
    WSAICMicrosoftAccountMultiFactorAuthenticationManager;
@protocol WSAICIMicrosoftAccountMultiFactorSessionInfo
, WSAICIMicrosoftAccountMultiFactorGetSessionsResult, WSAICIMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo,
    WSAICIMicrosoftAccountMultiFactorOneTimeCodedInfo, WSAICIMicrosoftAccountMultiFactorAuthenticationManager,
    WSAICIMicrosoftAccountMultiFactorAuthenticatorStatics;
