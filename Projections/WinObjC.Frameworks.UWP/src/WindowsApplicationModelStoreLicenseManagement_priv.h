...
// WindowsApplicationModelStoreLicenseManagement_priv.h
...
@class RTProxiedIterableNSArray_NSString, RTProxiedNSDictionary_NSString_WASLLicenseSatisfactionInfo;
