...
@class WUIIInkUnprocessedInput, WUIIInkStrokeInput, WUIIInkInputProcessingConfiguration, WUIIInkSynchronizer, WUIIInkPresenter,
    WUIIInkStrokesCollectedEventArgs, WUIIInkStrokesErasedEventArgs, WUIIInkPresenterRuler, WUIIInkPoint,
    WUIIInkDrawingAttributesPencilProperties, WUIIInkDrawingAttributes, WUIIInkStrokeRenderingSegment, WUIIInkStroke, WUIIInkStrokeBuilder,
    WUIIInkRecognitionResult, WUIIInkStrokeContainer, WUIIInkRecognizer, WUIIInkRecognizerContainer, WUIIInkManager;
...
, WUIIIInkStrokesErasedEventArgs, WUIIIInkPresenter, WUIIIInkInputProcessingConfiguration, WUIIIInkSynchronizer, WUIIIInkUnprocessedInput,
    WUIIIInkStrokeInput, WUIIIInkPresenterStencil, WUIIIInkPresenterRuler, WUIIIInkPresenterRulerFactory, WUIIIInkPoint,
    WUIIIInkPointFactory, WUIIIInkDrawingAttributes, WUIIIInkDrawingAttributes2, WUIIIInkDrawingAttributesPencilProperties,
    WUIIIInkDrawingAttributes3, WUIIIInkDrawingAttributesStatics, WUIIIInkStrokeRenderingSegment, WUIIIInkStroke, WUIIIInkStroke2,
    WUIIIInkStrokeBuilder, WUIIIInkStrokeBuilder2, WUIIIInkRecognitionResult, WUIIIInkStrokeContainer, WUIIIInkStrokeContainer2,
