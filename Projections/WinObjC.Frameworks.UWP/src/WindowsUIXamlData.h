...
@class WUXDCurrentChangingEventArgs, WUXDPropertyChangedEventArgs, WUXDBindingExpressionBase, WUXDBindingOperations, WUXDBindingBase,
    WUXDBindingExpression, WUXDRelativeSource, WUXDBinding, WUXDItemIndexRange, WUXDCollectionViewSource;
@class WUXDLoadMoreItemsResult;
@protocol WUXDIItemsRangeInfo
, WUXDISelectionInfo, WUXDICustomProperty, WUXDICustomPropertyProvider, WUXDINotifyPropertyChanged, WUXDISupportIncrementalLoading,
    WUXDIValueConverter, WUXDIBindingExpressionBase, WUXDIBindingExpressionBaseFactory, WUXDIBindingOperations,
    WUXDIBindingOperationsStatics, WUXDICurrentChangingEventArgs, WUXDICurrentChangingEventArgsFactory, WUXDIPropertyChangedEventArgs,
    ...
    WUXDIRelativeSource, WUXDIRelativeSourceFactory, WUXDIBinding, WUXDIBindingFactory, WUXDIBinding2, WUXDICollectionView,
    WUXDICollectionViewFactory, WUXDICollectionViewGroup, WUXDIItemIndexRange, WUXDIItemIndexRangeFactory, WUXDICollectionViewSource,
    WUXDICollectionViewSourceStatics;
