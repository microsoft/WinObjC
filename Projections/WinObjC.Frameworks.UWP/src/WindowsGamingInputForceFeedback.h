...
, WGIFIConditionForceEffect, WGIFIConditionForceEffectFactory, WGIFIConstantForceEffect, WGIFIPeriodicForceEffect,
    WGIFIPeriodicForceEffectFactory, WGIFIRampForceEffect, WGIFIForceFeedbackMotor;
