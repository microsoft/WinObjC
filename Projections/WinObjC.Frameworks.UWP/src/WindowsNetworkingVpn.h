...
, WNVIVpnCustomPrompt, WNVIVpnCustomEditBox, WNVIVpnCustomComboBox, WNVIVpnCustomTextBox, WNVIVpnCustomCheckBox, WNVIVpnCustomErrorBox,
    ...
    WNVIVpnDomainNameInfoFactory, WNVIVpnDomainNameInfo, WNVIVpnDomainNameInfo2, WNVIVpnDomainNameAssignment, WNVIVpnAppIdFactory,
    WNVIVpnAppId, WNVIVpnTrafficFilterFactory, WNVIVpnTrafficFilter, WNVIVpnTrafficFilterAssignment, WNVIVpnProfile, WNVIVpnPlugInProfile,
    WNVIVpnPlugInProfile2, WNVIVpnNativeProfile, WNVIVpnNativeProfile2, WNVIVpnManagementAgent;
