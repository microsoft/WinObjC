...
@class WUCCompositionObject, WUCCompositionAnimation, WUCCompositionBatchCompletedEventArgs, WUCCompositionEasingFunction,
    WUCCompositionBrush, WUCCompositionEffectBrush, WUCCompositionEffectSourceParameter, WUCCompositionGraphicsDevice, WUCCompositor,
    WUCCompositionPropertySet, WUCCompositionDrawingSurface, WUCCompositionColorBrush, WUCCompositionEffectFactory,
    WUCCompositionScopedBatch, WUCCompositionSurfaceBrush, WUCCompositionTarget, WUCCompositionCommitBatch, WUCCompositionAnimationGroup,
    WUCCompositionBackdropBrush, WUCCompositionMaskBrush, WUCCompositionNineGridBrush, WUCCubicBezierEasingFunction, WUCExpressionAnimation,
    WUCImplicitAnimationCollection, WUCLinearEasingFunction, WUCRenderingDeviceReplacedEventArgs, WUCCompositionShadow, WUCDropShadow,
    WUCStepEasingFunction, WUCVisual, WUCContainerVisual, WUCSpriteVisual, WUCLayerVisual, WUCCompositionClip, WUCInsetClip,
    WUCVisualCollection, WUCVisualUnorderedCollection, WUCCompositionLight, WUCAmbientLight, WUCDistantLight, WUCPointLight, WUCSpotLight,
    WUCKeyFrameAnimation, WUCColorKeyFrameAnimation, WUCQuaternionKeyFrameAnimation, WUCScalarKeyFrameAnimation,
    WUCVector2KeyFrameAnimation, WUCVector3KeyFrameAnimation, WUCVector4KeyFrameAnimation;
...
, WUCIColorKeyFrameAnimation, WUCICompositionAnimation, WUCICompositionAnimation2, WUCICompositionAnimationBase,
    WUCICompositionAnimationGroup, WUCICompositionBackdropBrush, WUCICompositionBatchCompletedEventArgs, WUCICompositionBrush,
    WUCICompositionClip, WUCICompositionClip2, WUCICompositionColorBrush, WUCICompositionCommitBatch, WUCICompositionDrawingSurface,
    WUCICompositionEasingFunction, WUCICompositionEffectBrush, WUCICompositionEffectFactory, WUCICompositionEffectSourceParameter,
    WUCICompositionEffectSourceParameterFactory, WUCICompositionGraphicsDevice, WUCICompositionLight, WUCICompositionMaskBrush,
    WUCICompositionNineGridBrush, WUCICompositionObject, WUCICompositionObject2, WUCICompositionPropertySet, WUCICompositionPropertySet2,
    WUCICompositionScopedBatch, WUCICompositionShadow, WUCICompositionSurface, WUCICompositionSurfaceBrush, WUCICompositionSurfaceBrush2,
    WUCICompositionTarget, WUCICompositor, WUCICompositor2, WUCIContainerVisual, WUCICubicBezierEasingFunction, WUCIDistantLight,
    WUCIDropShadow, WUCIExpressionAnimation, WUCIImplicitAnimationCollection, WUCIInsetClip, WUCIKeyFrameAnimation, WUCIKeyFrameAnimation2,
    WUCILayerVisual, WUCILinearEasingFunction, WUCIPointLight, WUCIQuaternionKeyFrameAnimation, WUCIRenderingDeviceReplacedEventArgs,
    WUCIScalarKeyFrameAnimation, WUCISpotLight, WUCISpriteVisual, WUCISpriteVisual2, WUCIStepEasingFunction, WUCIVector2KeyFrameAnimation,
    WUCIVector3KeyFrameAnimation, WUCIVector4KeyFrameAnimation, WUCIVisual, WUCIVisualCollection, WUCIVisualUnorderedCollection,
    ...
    WUCICompositionLightFactory, WUCICompositionObjectFactory, WUCICompositionShadowFactory, WUCIContainerVisualFactory,
    WUCIKeyFrameAnimationFactory, WUCIVisualFactory;
