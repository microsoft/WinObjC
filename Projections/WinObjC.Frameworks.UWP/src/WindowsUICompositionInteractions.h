...
@class WUCIInteractionTrackerCustomAnimationStateEnteredArgs, WUCIInteractionTrackerIdleStateEnteredArgs,
    WUCIInteractionTrackerInertiaStateEnteredArgs, WUCIInteractionTrackerInteractingStateEnteredArgs,
    WUCIInteractionTrackerRequestIgnoredArgs, WUCIInteractionTrackerValuesChangedArgs, WUCIInteractionTracker,
    WUCICompositionInteractionSourceCollection, WUCIInteractionTrackerInertiaModifier, WUCIInteractionTrackerInertiaRestingValue,
    WUCIInteractionTrackerInertiaMotion, WUCIVisualInteractionSource;
@protocol WUCIICompositionInteractionSource
, WUCIICompositionInteractionSourceCollection, WUCIIInteractionTrackerStatics, WUCIIInteractionTrackerOwner, WUCIIInteractionTracker,
    WUCIIInteractionTrackerCustomAnimationStateEnteredArgs, WUCIIInteractionTrackerIdleStateEnteredArgs,
    WUCIIInteractionTrackerInteractingStateEnteredArgs, WUCIIInteractionTrackerInertiaModifier,
    WUCIIInteractionTrackerInertiaRestingValueStatics, WUCIIInteractionTrackerInertiaRestingValue,
    WUCIIInteractionTrackerInertiaMotionStatics, WUCIIInteractionTrackerInertiaMotion, WUCIIInteractionTrackerInertiaStateEnteredArgs,
    WUCIIInteractionTrackerRequestIgnoredArgs, WUCIIInteractionTrackerValuesChangedArgs, WUCIIVisualInteractionSourceStatics,
    WUCIIVisualInteractionSource, WUCIIInteractionTrackerInertiaModifierFactory;
