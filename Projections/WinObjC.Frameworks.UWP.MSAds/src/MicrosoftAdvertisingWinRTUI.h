...
@class MAWUAdErrorEventArgs, MAWUManipulationStateChangedEventArgs, MAWUPointerMoveEventArgs, MAWUMouseWheelEventArgs,
    MAWUPointerDownEventArgs, MAWUAdControl, MAWUExpandProperties, MAWUblank, MAWUInterstitialAd, MAWUVpaidEventArgs;
@protocol MAWU__IAdErrorEventArgsPublicNonVirtuals
, MAWU__IManipulationStateChangedEventArgsPublicNonVirtuals, MAWU__IManipulationStateChangedEventArgsFactory,
    MAWU__IPointerMoveEventArgsPublicNonVirtuals, MAWU__IMouseWheelEventArgsPublicNonVirtuals, MAWU__IPointerDownEventArgsPublicNonVirtuals,
    MAWU__IAdControlPublicNonVirtuals, MAWU__IAdControlProtectedNonVirtuals, MAWU__IExpandPropertiesPublicNonVirtuals,
    MAWU__IExpandPropertiesFactory, MAWU__IExpandPropertiesStatics, MAWUIAdvertisingWebBrowser, MAWU__IblankPublicNonVirtuals,
    MAWU__IInterstitialAdPublicNonVirtuals, MAWU__IInterstitialAdProtectedNonVirtuals, MAWU__IVpaidEventArgsPublicNonVirtuals;
...
+ (MAWUExpandProperties*)makeInstance1:(int)width
                       ...
                       lockOrientation:(BOOL)lockOrientation ACTIVATOR;
#if defined(__cplusplus)
+ (instancetype)createWith:(IInspectable*)obj __attribute__((ns_returns_autoreleased));
#endif
