...
@class MASWAdvertisement, MASWAdErrorEventArgs, MASWAdTagCollection, MASWProjectedContext, MASWAdPlacement, MASWVideoResource,
    MASWAdExtension, MASWActivityReporter, MASWAdPackage, MASWAdPod, MASWAdSchedule, MASWProjectedMediaConstraints, MASWAdScheduleResult,
...
, MASW__IAdErrorEventArgsPublicNonVirtuals, MASW__IAdErrorEventArgsFactory, MASW__IAdTagCollectionPublicNonVirtuals,
    MASW__IProjectedContextPublicNonVirtuals, MASW__IAdPlacementPublicNonVirtuals, MASW__IAdPlacementFactory,
    MASW__IVideoResourcePublicNonVirtuals, MASW__IAdExtensionPublicNonVirtuals, MASW__IAdExtensionFactory,
    MASW__IActivityReporterPublicNonVirtuals, MASW__IAdPackagePublicNonVirtuals, MASW__IAdPodPublicNonVirtuals,
    MASW__IAdSchedulePublicNonVirtuals, MASW__IProjectedMediaConstraintsPublicNonVirtuals, MASW__IProjectedMediaConstraintsFactory,
    MASW__IProjectedMediaConstraintsStatics, MASW__IAdScheduleResultPublicNonVirtuals, MASW__IAdSchedulerPublicNonVirtuals,
    MASW__IAdSchedulerStatics, MASW__ISdkInfoProviderPublicNonVirtuals, MASW__ISdkInfoProviderStatics, MASW__IEventLoggingPublicNonVirtuals,
    MASW__IEventLoggingStatics, MASW__IProjectedIAdLoggerPublicNonVirtuals, MASW__IPlatformDependencyPublicNonVirtuals,
    MASW__IPlatformDependencyStatics;
