...
- (void)viewDidLoad {
    ...
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"Controls", viewTitleKeyName,
                               controlsViewController, controllerKeyName,
                               nil]];
    ...
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"TextFields", viewTitleKeyName,
                               textFieldsViewController, controllerKeyName,
                               nil]];
    
    // SearchBar
    SearchBarViewController *searchBarViewController = [[SearchBarViewController alloc] init];
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"SearchBar", viewTitleKeyName,
                               searchBarViewController, controllerKeyName,
                               nil]];
    
    // OpenGL
    OpenGLES11ViewController *glViewController = [[OpenGLES11ViewController alloc] init];
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"Open GLES 1.1", viewTitleKeyName,
                               glViewController, controllerKeyName,
                               nil]];
    ...
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"Pickers", viewTitleKeyName,
                               pickersViewController, controllerKeyName,
                               nil]];
    
    // Images
    ImagesViewController *imagesViewController = [[ImagesViewController alloc] init];
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"ImageView", viewTitleKeyName,
                               imagesViewController, controllerKeyName,
                               nil]];
    
    // Web
    WebViewController *webViewController = [[WebViewController alloc] init];
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"WebView", viewTitleKeyName,
                               webViewController, controllerKeyName,
                               nil]];
    ...
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"Segments", viewTitleKeyName,
                               segmentsViewController, controllerKeyName,
                               nil]];

    // Alerts
    AlertsViewController *alertsViewController = [[AlertsViewController alloc] init];
    [self.menuItems addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                               @"Alerts", viewTitleKeyName,
                               alertsViewController, controllerKeyName,
                               nil]];
