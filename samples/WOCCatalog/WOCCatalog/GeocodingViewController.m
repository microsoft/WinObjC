...
- (void)startGeocodingCalls {
    ...
    [geocoder3 geocodeAddressString:self.locationName1
                   completionHandler:^(NSArray* placemarks, NSError* error) {
                       ...
                       if ([placemarks count] > 0) {
                           ...
                           self.rowLabelDetail3 = [NSString stringWithFormat:@"Out: %@ %@", [firstPlacemark name], [firstPlacemark location]];
                       }
    ...
    [geocoder4 geocodeAddressString:self.locationName2 inRegion:region1
                  completionHandler:^(NSArray* placemarks, NSError* error) {
                      if (error) {
                      ...
                      if ([placemarks count] > 0) {
                          ...
                          self.rowLabelDetail4 = [NSString stringWithFormat:@"Out: %@ %@", [firstPlacemark name], [firstPlacemark location]];
                      }
